...
{
    /// <summary>
    /// Summary description for StoreEligibilityCriteriaLoad.
    /// </summary>
    class StoreEligibilityCriteriaLoad
    {
        /// <summary>
        ...
        static int Main(string[] args)
        {
            ...
            string eventLogID = "MIDStoreEligibilityCriteriaLoad";
            string sourceModule = "StoreEligibilityCriteriaLoad.cs";
            ...
            //StoreEligibilityCriteriaLoadProcess dpclp;
            ...
            try
            {
                ...
                try
                {
                    ...
                    authentication = SAB.ClientServerSession.UserLogin(userId, passWd, eProcesses.StoreEligibilityCriteraLoad);
                    ...
                    if (fileLocation == null || fileLocation == "")
                    {
                        ...
                        msgText += "Store Eligibility Load process NOT run";
                    ...
                    else
                    {
                        if (!File.Exists(fileLocation))
                        {
                            ...
                            {
                                SAB.ClientServerSession.Audit.Add_Msg(eMIDMessageLevel.Severe, "Store Eligibility Load process failed", sourceModule);
                        ...
                        else
                        {
                            ...
                            if (txnFileInfo.Length == 0)
                            {
                                ...
                                {
                                    SAB.ClientServerSession.Audit.Add_Msg(eMIDMessageLevel.Severe, "Store Eligibility Load failed", sourceModule);
                                    SAB.ClientServerSession.Audit.UpdateHeader(eProcessCompletionStatus.Failed, eMIDTextCode.sum_Failed, "", eMIDMessageLevel.Severe);
                                }
                                highestMessage = eMIDMessageLevel.None;
                                try
                            ...
                            else
                            {
                                ...
                                //dpclp = new StoreEligibilityCriteriaLoadProcess(SAB, ref errorFound);
                                if (fileLocation.Substring(fileLocation.Length - 4).ToUpper() == ".XML")
                                {
                                    errorFound = SAB.HierarchyServerSession.LoadXMLEligibilityFile(SAB, fileLocation, delimiter, ref errorFound);
                                    //dpclp.ProcessXMLTransFile(fileLocation, delimiter, ref errorFound);
                                }
                                else
                                {
                                    errorFound = SAB.HierarchyServerSession.LoadDelimitedEligibilityFile(SAB, fileLocation, delimiter, ref errorFound);
