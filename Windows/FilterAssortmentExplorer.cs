...
{
	public partial class FilterAssortmentExplorer : ExplorerBase
	{
		//=======
		// FIELDS
		//=======
        ...
        public FilterAssortmentExplorer(SessionAddressBlock aSAB, ExplorerAddressBlock aEAB, Form aMainMDIForm)
			: base(aSAB, aEAB, aMainMDIForm)
		{
			aEAB.FilterExplorerAssortment = this;
		}
		...
		override protected void InitializeTreeView()
		{
			try
			{
				TreeView = new FilterAssortmentTreeView();
				TreeView.InitializeTreeView(SAB, false, MainMDIForm);
                ((FilterAssortmentTreeView)TreeView).EAB = base._EAB;
        ...
        {
            FilterAssortmentTreeView tv = (FilterAssortmentTreeView)TreeView;
            tv.EditThisFilter(filterRID);
        }
        ...
        public MIDFilterNode UserNode
        {
            get
            {
                return ((FilterAssortmentTreeView)TreeView).UserNode;
            }
        }
        public MIDFilterNode GlobalNode
        {
            get
            {
                return ((FilterAssortmentTreeView)TreeView).GlobalNode;
            }
        }
