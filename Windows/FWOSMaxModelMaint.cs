...
{
	/// <summary>
	/// Summary description for FWOSMaxModelMaint.
	/// </summary>
	public class frmFWOSMaxModelMaint : ModelFormBase
	{
...
//		private CalendarDateSelector _frmCalDtSelector;
		private ProfileList _FWOSMaxModelProfileList;
        //private System.Windows.Forms.Label lblModelName;
        //private Infragistics.Win.UltraWinGrid.UltraGrid ugModel;
		private System.Windows.Forms.Label lblFWOSMaxDefault;
		private System.Windows.Forms.TextBox txtFWOSMaxDefault;
		...
		public frmFWOSMaxModelMaint(SessionAddressBlock aSAB) : base (aSAB)
		{
			try
			{
				//
				...
				LoadModelComboBox();
				SetText();
				FunctionSecurity = SAB.ClientServerSession.GetMyUserFunctionSecurityAssignment(eSecurityFunctions.AdminFWOSMax);
				DetermineSecurity();
...
//End Track #3707 - JScott - Null Reference on model save
		...
		protected override void Dispose( bool disposing )
		{
			try
			{
				if( disposing )
				{
                    ...
                    //End TT#169
					this.txtFWOSMaxDefault.TextChanged -= new System.EventHandler(this.txtFWOSMaxDefault_TextChanged);
					this.txtFWOSMaxDefault.Leave -= new System.EventHandler(this.txtFWOSMaxDefault_Leave);
				}
		...
		private void InitializeComponent()
		{
            ...
            this.lblFWOSMaxDefault = new System.Windows.Forms.Label();
            this.txtFWOSMaxDefault = new System.Windows.Forms.TextBox();
            ...
            this.ugModel.Location = new System.Drawing.Point(26, 96);
            ...
            // lblFWOSMaxDefault
            // 
            this.lblFWOSMaxDefault.Location = new System.Drawing.Point(190, 55);
            this.lblFWOSMaxDefault.Name = "lblFWOSMaxDefault";
            this.lblFWOSMaxDefault.Size = new System.Drawing.Size(120, 26);
            this.lblFWOSMaxDefault.TabIndex = 27;
            this.lblFWOSMaxDefault.Text = "Default Value:";
            this.lblFWOSMaxDefault.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
            // 
            // txtFWOSMaxDefault
            // 
            this.txtFWOSMaxDefault.Location = new System.Drawing.Point(320, 56);
            this.txtFWOSMaxDefault.Name = "txtFWOSMaxDefault";
            this.txtFWOSMaxDefault.Size = new System.Drawing.Size(79, 20);
            this.txtFWOSMaxDefault.TabIndex = 28;
            this.txtFWOSMaxDefault.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
            this.txtFWOSMaxDefault.TextChanged += new System.EventHandler(this.txtFWOSMaxDefault_TextChanged);
            this.txtFWOSMaxDefault.Leave += new System.EventHandler(this.txtFWOSMaxDefault_Leave);
            // 
            // frmFWOSMaxModelMaint
            // 
            this.ClientSize = new System.Drawing.Size(720, 517);
            this.Controls.Add(this.txtFWOSMaxDefault);
            this.Controls.Add(this.lblFWOSMaxDefault);
            this.Name = "frmFWOSMaxModelMaint";
            ...
            this.Controls.SetChildIndex(this.lblFWOSMaxDefault, 0);
            this.Controls.SetChildIndex(this.txtFWOSMaxDefault, 0);
		...
		private void ugModel_InitializeLayout(object sender, Infragistics.Win.UltraWinGrid.InitializeLayoutEventArgs e)
		{
			try
			{
                ...
                InfragisticsLayout layout = layoutData.InfragisticsLayout_Read(SAB.ClientServerSession.UserRID, eLayoutID.FWOSMaxModelGrid);
		...
		override public void InitializeForm()
		{
			try
			{
				...
				if (_modelLocked)
				{
                    SAB.HierarchyServerSession.DequeueModel(eModelType.FWOSMax, _modelRID);
					_modelLocked = false;
				}
				_tableLoaded = false;
				this.txtFWOSMaxDefault.Text = "";
...
//End   TT#1638 - MD - Revised Model Save - RBeck
				...
				Format_Title(eDataState.New, eMIDTextCode.frm_FWOSMaxModel, null);
				SetReadOnly(true);
				DetermineSecurity();
				FormLoaded = true;
			}
		...
		override public bool InitializeForm(string currModel)
        {
			...
			try
			{
				...
				if (currModel == "")
				{
                    ...
                    btnDelete.Enabled = false;
					if (_FWOSMaxModelProfileList.Count > 0)
					{
						displayModel = false;
				...
				FWOSmmp = SAB.HierarchyServerSession.GetFWOSMaxModelData(currModel);
				if (displayModel)
				{
					if (!_newModel && FunctionSecurity.AllowUpdate)
					{
                        FWOSmmp = (FWOSMaxModelProfile)SAB.HierarchyServerSession.GetModelDataForUpdate(eModelType.FWOSMax, FWOSmmp.Key, true);
					...
					if (initializeSuccessful)
					{
                        ...
                        Format_Title(dataState, eMIDTextCode.frm_FWOSMaxModel, FWOSmmp.ModelID);
						_modelRID = FWOSmmp.Key;
						_currModel = FWOSmmp.ModelID;
						if (FWOSmmp.FWOSMaxModelDefault > Include.Undefined)
						{
							this.txtFWOSMaxDefault.Text = FWOSmmp.FWOSMaxModelDefault.ToString(CultureInfo.CurrentUICulture);
						}
						_gridDataTable.Rows.Clear();
						foreach (FWOSMaxModelEntry smme in FWOSmmp.ModelEntries)
						{
							//Begin TT#169 - JSmith - enter max of 1000 and receive 'must be integer'
                            //_gridDataTable.Rows.Add(new object[] {smme.FWOSMaxModelEntryValue.ToString(CultureInfo.CurrentUICulture), smme.DateRange, smme.DateRange.DisplayDate});
                            _gridDataTable.Rows.Add(new object[] { smme.FWOSMaxModelEntryValue, smme.DateRange, smme.DateRange.DisplayDate });
                            //End TT#169
						}
						...
						foreach(  UltraGridRow gridRow in ugModel.Rows )
						{
							...
							FWOSMaxModelEntry smme = (FWOSMaxModelEntry)FWOSmmp.ModelEntries[index];
				...
				else
				{
                    ...
                    Format_Title(dataState, eMIDTextCode.frm_FWOSMaxModel, "");
					SetReadOnly(FunctionSecurity.AllowUpdate);  //Security changes - 1/24/2005 vg
				}
				if (currModel == "")
				{
		...
		{
            this.ugModel.Text = MIDText.GetTextOnly(eMIDTextCode.frm_FWOSMaxModel);
            this.Text = MIDText.GetTextOnly(eMIDTextCode.frm_FWOSMaxModel);
		}
...
//End     TT#1638 - Revised Model Save - RBeck
			...
			try
			{
				...
				if (_modelRID != Include.NoRID)
				{
				    ...
				    //BEGIN TT#601-MD-VStuart-FWOS Model attempts delete while InUse
                    {
                        ...
                        var emp = new FWOSMaxModelProfile(_modelRID);
                        eProfileType type = emp.ProfileType;
                        int rid = _modelRID;

                        if (!CheckInUse(type, rid, false))
                        {
				            FWOSMaxModelProfile FWOSmmp = new FWOSMaxModelProfile(_modelRID);
				            ...
				            _gridDataTable.Rows.Clear();
				            this.txtFWOSMaxDefault.Text = "";
				            //_gridDataTable.Rows.Add(new object[] { "", ""}); //TT#230 - MD - DOConnell - FWOS model delete error
				...
				if (itemDeleted)
				{
					if (cbModelName.Items.Count > 0)
					{
						...
						string modelName = ((ModelName)_FWOSMaxModelProfileList[nextItem]).ModelID;
        ...
        protected override DataTable GetFilteredModels(string FWOSMaxModelNameFilter, bool isCaseSensitive)
        {
            try
            {
                MerchandiseHierarchyData modelsData = new MerchandiseHierarchyData();

                return modelsData.GetFilteredFWOSMaxModels(FWOSMaxModelNameFilter, isCaseSensitive);
            }
            catch (Exception ex)
            {
		...
		override protected void BeforeClosing()
		{
			try
			{
				if (FunctionSecurity.AllowUpdate)
				{
					...
					{
						InfragisticsLayoutData layoutData = new InfragisticsLayoutData();
                        layoutData.InfragisticsLayout_Save(SAB.ClientServerSession.UserRID, eLayoutID.FWOSMaxModelGrid, ugModel);
					}
				}
		...
		override protected void AfterClosing()
		{
			...
			{
				HandleException (ex, "frmFWOSMaxModelMaint");
			}
		}
...
//Begin     TT#1638 - MD - Revised Model Save - RBeck
        ...
        protected override void ModelPreSave()
        {
			...
			FWOSmmp = new FWOSMaxModelProfile(_modelRID);
            ...
            if (this.txtFWOSMaxDefault.Text != "")
            {
                if (!DefaultValueValid(this.txtFWOSMaxDefault.Text, ref errorMessage))
                {
                ...
                {
						FWOSmmp.FWOSMaxModelDefault = Convert.ToDouble(this.txtFWOSMaxDefault.Text, CultureInfo.CurrentUICulture);
                }
            }
            else
            {
					FWOSmmp.FWOSMaxModelDefault = Include.Undefined;
            }
            ...
            foreach (UltraGridRow gridRow in ugModel.Rows)
            {
                ...
                {
						modelEntry.FWOSMaxModelEntryValue = Convert.ToDouble(gridRow.Cells["Value"].Value, CultureInfo.CurrentUICulture);
                }
        ...
        //        int saveKey;
                ...
                //    else
                //    {
                //        FWOSmmp.FWOSModModelDefault = Convert.ToDouble(this.txtFWOSMaxDefault.Text, CultureInfo.CurrentUICulture);
                //    }
                //}
                //else
                //{
...
//                    {
//                        this.txtFWOSMaxDefault.SelectionStart = 0;
//                        this.txtFWOSMaxDefault.SelectionLength = this.txtFWOSMaxDefault.Text.Length;
//                        this.txtFWOSMaxDefault.Select();
//                        this.txtFWOSMaxDefault.Focus();
//                    }
//                    else
//                    {
...
//        }
        ...
        {
            _FWOSMaxModelProfileList = SAB.HierarchyServerSession.GetFWOSMaxModels();
            return _FWOSMaxModelProfileList;
        }
        ...
        protected override void GetModelRID(string _saveAsName, ref int _modelRID)
        {
            FWOSmmp.ModelID = _saveAsName;
            FWOSmmp.Key = _modelRID;
            _modelRID = SAB.HierarchyServerSession.FWOSMaxModelUpdate(FWOSmmp);
        }
        ...
        {
            FWOSMaxModelProfile checkExists = SAB.HierarchyServerSession.GetFWOSMaxModelData(_SaveAsName);
...
//End     TT#1638 - MD - Revised Model Save - RBeck
		...
		private void txtFWOSMaxDefault_Leave(object sender, System.EventArgs e)
		{
			try
			{
				string errorMessage = null;
				...
				{
					if (!DefaultValueValid(txtFWOSMaxDefault.Text, ref errorMessage))
					{
		...
		private bool DefaultValueValid(string defaultValue, ref string errorMessage)
		{
			...
			if (ErrorFound)
			{
				ErrorProvider.SetError (this.txtFWOSMaxDefault,errorMessage);
				return false;
			}
			else
			{
				ErrorProvider.SetError (this.txtFWOSMaxDefault,"");
				return true;
			}
		}
...
//End     TT#1638 - MD - Revised Model Save - RBeck		
		...
		private void txtFWOSMaxDefault_TextChanged(object sender, System.EventArgs e)
		{
			if (FormLoaded && _tableLoaded)
			{
				ChangePending = true;
