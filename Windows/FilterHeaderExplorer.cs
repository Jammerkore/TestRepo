...
{
	public partial class FilterHeaderExplorer : ExplorerBase
	{
		//=======
		// FIELDS
		//=======
        ...
        public FilterHeaderExplorer(SessionAddressBlock aSAB, ExplorerAddressBlock aEAB, Form aMainMDIForm)
			: base(aSAB, aEAB, aMainMDIForm)
		{
			aEAB.FilterExplorerHeader = this;
		}
		...
		override protected void InitializeTreeView()
		{
			try
			{
				TreeView = new FilterHeaderTreeView();
				TreeView.InitializeTreeView(SAB, false, MainMDIForm);
                ((FilterHeaderTreeView)TreeView).EAB = base._EAB;
        ...
        {
            FilterHeaderTreeView tv = (FilterHeaderTreeView)TreeView;
        ...
        public MIDFilterNode UserNode
        {
            get
            {
                return ((FilterHeaderTreeView)TreeView).UserNode;
            }
        }
        public MIDFilterNode GlobalNode
        {
            get
            {
                return ((FilterHeaderTreeView)TreeView).GlobalNode;
            }
        }
