...
namespace MIDRetail.DataCommon
{
    ...
    /// </summary>
    public partial class MIDMessageBox : System.Windows.Forms.Form
    {
        /// <summary>
        ...
        public MIDMessageBox(string caption, string message, Color[] button_colors, string[] answers, int default_answer, string silent_box_text, Icon icon, bool verticalButtons)
        {
            InitializeComponent();
			...
			construct_form(caption, message, button_colors, answers, default_answer, silent_box_text, image, verticalButtons);
        }
        ...
        public MIDMessageBox(string caption, string message, Color[] button_colors, string[] answers, int default_answer, string silent_box_text, Image image, bool verticalButtons)
        {
            InitializeComponent();
        ...
        void construct_form(string caption, string message, Color[] button_colors, string[] answers, int default_answer, string silent_box_text, Image image, bool verticalButtons)
        {
            this.Text = caption;
        ...
        /// <summary>
        /// Show MIDMessageBox as a dialog box and get user's answer
        /// </summary>
        ...
        private void MIDMessageBox_Load(object sender, EventArgs e)
        {
        }
    }
}
