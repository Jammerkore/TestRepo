...
//{
//    public class FilterStoreGroupTreeView : MIDTreeView
//    {
//        //=======
//        // FIELDS
//        //=======
...
//        private filterTypes treeFilterType = filterTypes.StoreGroupFilter;

//        //=============
//        // CONSTRUCTORS
//        //=============

//        public FilterStoreGroupTreeView()
//        {
...
//                    //End TT#677 - JScott - Tasklists disappearing from Tasklist Explorer
//                    {
//                        folderProf = new FolderProfile(Include.NoRID, SAB.ClientServerSession.UserRID, eProfileType.StoreGroupMainUserFolder, "My Filters", SAB.ClientServerSession.UserRID);
...
//                    if (dtFolders == null)
//                    {
//                        throw new Exception("Global StoreGroup Filter Folder not defined");
//                    }
//                    else if (dtFolders.Rows.Count != 1)
//                    {
//                        throw new Exception("More than one Global StoreGroup Filter Folder is defined");
//                    }
...
//                {
//                    dtFilters = _dlFilters.FilterReadParent(treeFilterType, eProfileType.FilterStoreGroup, userRIDList);
//                    dtFolders = _dlFolder.Folder_Read(userRIDList, eProfileType.StoreGroupSubFolder, true, false);
//                    dtFolderItems = _dlFolder.Folder_Item_Read(userRIDList, folderTypeList, eProfileType.FilterStoreGroup, true, false);
//                    dtFilterShortcuts = _dlFolder.Folder_Shortcut_Item_Read(userRIDList, eProfileType.FilterStoreGroup);
...
//                    dtFolderItems = _dlFolder.Folder_Item_Read(userRIDList, folderTypeList, eProfileType.FilterStoreGroup, false, true);
...
//        {
//            int key;
//            StoreGroupFilterProfile filterProf;
//            FolderProfile folderProf;
...
//                {
//                    case eProfileType.FilterStoreGroup:

//                        objEnqueue = EnqueueObject((StoreGroupFilterProfile)aNode.Profile, false);
...
//                            //try
//                            //{
//                            _dlFilters.UpdateFilterName(aNode.Profile.Key, aNode.UserId, aNewName);
...
//                            filterProf = (StoreGroupFilterProfile)aNode.Profile;
...
//                    case eProfileType.StoreGroupMainGlobalFolder:
...
//        private bool _executeAfterEditing = false; //TT#1313-MD -jsobek -StoreGroup Filters  
//        /// <summary>
...
//                if (aNode != null)
//                {
//                    if (aNode.Profile.ProfileType == eProfileType.FilterStoreGroup)
//                    {
//                        node = (MIDFilterNode)aNode;

//                        filterProf = (StoreGroupFilterProfile)node.Profile;
//                        objEnqueue = EnqueueObject(filterProf, true);

//                        if (objEnqueue != null)
//                        {
//                            //filterProperties = new frmFilterProperties(SAB, (MIDFilterNode)node.Parent, _userNode, _globalNode, (StoreGroupFilterProfile)node.Profile, objEnqueue.IsInConflict);
//                            int _initialUserRID = ((StoreGroupFilterProfile)node.Profile).UserRID;
//                            int _initialOwnerRID = ((StoreGroupFilterProfile)node.Profile).OwnerUserRID;
...
//                            //filterProperties = new frmFilterBuilder(SAB, EAB, isReadOnly); //TT#1313-MD -jsobek -StoreGroup Filters  

//                            filterProperties = SharedRoutines.GetFilterFormForExistingFilter(filterProf.Key, SAB, EAB, isReadOnly, _executeAfterEditing); //TT#1313-MD -jsobek -StoreGroup Filters  
...
//            }
//        }
//        //Begin TT#1313-MD -jsobek -StoreGroup Filters
...
//           }
//        }
//        //End TT#1313-MD -jsobek -StoreGroup Filters
...
//        {
//            return aClipboardDataType == eProfileType.FilterStoreGroup;
//        }
...
//                            if (node.Profile.ProfileType != eProfileType.FilterStoreGroup)
//                            {
...
//                            }
//                        }
//                        else if (node.NodeProfileType == eProfileType.StoreGroupSubFolder || node.isFolderShortcut)
//                        {
...
//            try
//            {
//                if (aSelectedNodes.ClipboardDataType == eProfileType.FilterStoreGroup ||
...
//                    //string inUseTitle = Regex.Replace(etype.ToString(), "((?<=[a-z])[A-Z]|[A-Z](?=[a-z]))", " $1").Trim(); //TT#1532-MD -jsobek -Add In Use for StoreGroup Characteristics
//                    string inUseTitle = InUseUtility.GetInUseTitleFromProfileType(etype); //TT#1532-MD -jsobek -Add In Use for StoreGroup Characteristics
//                    bool display = false;
...
//                        (node.isChildShortcut && node.Profile.ProfileType == eProfileType.StoreGroupSubFolder))
//                    {
...
//                            }
//                            // End TT#437-MD - JSmith - Client application will not start due to a missing item on an explorer (Null reference on Client App startup.)
//                            filterProf = new StoreGroupFilterProfile(itemRow);
...
//        public MIDFilterNode BuildFilterNode(StoreGroupFilterProfile prof, MIDTreeNode aParentNode, int aUserId)
//        {
//            MIDFilterNode newNode;
...
//        private GenericEnqueue EnqueueObject(StoreGroupFilterProfile aFilterProf, bool aAllowReadOnly)
//        {
//            GenericEnqueue objEnqueue;
//            string errMsg;
...
//                    return newNode;
//                }
//                else if (aFromNode.NodeProfileType == eProfileType.FilterStoreGroup)
//                {
//                    filterProf = (StoreGroupFilterProfile)aFromNode.Profile;
...
//                if (aFromNode.NodeProfileType == eProfileType.FilterStoreGroup)
//                {
//                    filterProf = (StoreGroupFilterProfile)aFromNode.Profile;
...
//                {
//                    filterProf = (StoreGroupFilterProfile)((StoreGroupFilterProfile)aFromNode.Profile).Clone();
//                    filterProf.UserRID = aToNode.UserId;
//                    filterProf.OwnerUserRID = aToNode.UserId;
...
//                        //Begin TT#1376-MD -jsobek -Copy/Paste of StoreGroup Filter does not create Stored Procedure 
...
//                        BuildStoreGroupFromFilter(f); 
//                        newNode = AfterSave(f);
//                        filterEngineSQLForStoreGroup.CreateOrUpdateSqlForFilter(f);

//                       // this.EAB.AllocationWorkspaceExplorer.BindFilterComboBox();
//                        //End TT#1376-MD -jsobek -Copy/Paste of StoreGroup Filter does not create Stored Procedure 
...
//            }
//        }
//        private void BuildStoreGroupFromFilter(filter f)
//        {
//            StoreMgmt.AddStoreGroup(f.filterName, false, f.ownerUserRID, f.filterRID); // SAB.StoreServerSession.AddGroup(f.filterName, false, f.ownerUserRID, f.filterRID);
//        }
...
//                        try
//                        {
//                            _dlFolder.Folder_Item_Delete(aNode.Profile.Key, eProfileType.FilterStoreGroup);
//                            _dlFolder.Folder_Shortcut_DeleteAll(aNode.Profile.Key, eProfileType.FilterStoreGroup);
//                            _dlFolder.CommitData();
//                        }
...
//                        //try
//                        //{
//                        //    _dlFilters.RemoveFilterProcedure(aNode.Profile.Key, filterTypes.StoreGroupFilter);
//                        //}
//                        //catch (DatabaseForeignKeyViolation)
//                        //{
//                        //    MessageBox.Show(SAB.ClientServerSession.Audit.GetText(eMIDTextCode.msg_DeleteFailedDataInUse), Text, MessageBoxButtons.OK, MessageBoxIcon.Error);
...
//                    try
//                    {
//                        _dlFolder.Folder_Shortcut_Delete(aNode.ParentId, aNode.Profile.Key, eProfileType.FilterStoreGroup);
//                        _dlFolder.CommitData();
//                    }
//                    catch (DatabaseForeignKeyViolation)
//                    {
...
//                    try
//                    {
//                        secAdmin.DeleteUserItemByTypeAndRID((int)eProfileType.FilterStoreGroup, f.filterRID);
//                        secAdmin.AddUserItem(userRID, (int)eProfileType.FilterStoreGroup, f.filterRID, ownerRID);
//                        secAdmin.CommitData();
//                    }
//                    catch (Exception exc)
//                    {
...
//                    try
//                    {
//                        _dlFolder.Folder_Item_Insert(parentNode.NodeRID, f.filterRID, eProfileType.FilterStoreGroup);
//                        _dlFolder.CommitData();
//                    }
//                    catch (Exception exc)
//                    {
...
//                    StoreGroupFilterProfile prof = new StoreGroupFilterProfile(f.filterRID);
//                    prof.Name = f.filterName;
//                    prof.UserRID = f.userRID;
//                    prof.OwnerUserRID = f.ownerUserRID;
//                    //Begin TT#1424-MD -jsobek -StoreGroup Filter- Result Limit - Copy-Paste a Global filter to user that has a restricted limit after the copy to user the Result limit changes to Unrestricted.
//                    prof.IsLimited = f.isLimited;
//                    prof.ResultLimit = (int)f.resultLimit;
//                    //End TT#1424-MD -jsobek -StoreGroup Filter- Result Limit - Copy-Paste a Global filter to user that has a restricted limit after the copy to user the Result limit changes to Unrestricted.
...
//                    StoreGroupFilterProfile prof = (StoreGroupFilterProfile)node.Profile;
//                    prof.Name = f.filterName;
//                    prof.IsLimited = f.isLimited;
//                    prof.ResultLimit = (int)f.resultLimit;
