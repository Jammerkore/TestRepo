...
{
    public class TaskHeaderLoad : TaskBase
    {
        //=======
        // FIELDS
        //=======
        ...
        private string TaskDirectory => string.IsNullOrEmpty(MIDConfigurationManager.AppSettings["FileDirectory"]) ? @"C:\Logility\ROData\Headers" :
                    string.Concat(MIDConfigurationManager.AppSettings["FileDirectory"], @"\Headers");
