...
{
    public class TaskVSWCriteriaLoad : TaskBase
    {
        //=======
        // FIELDS
        //=======
        ...
        {
            ROTaskVSWCriteriaLoad ROTask = null;
            ...
            if (taskParameters.Sequence < TaskListProperties.Tasks.Count
                && TaskListProperties.Tasks[taskParameters.Sequence] is ROTaskVSWCriteriaLoad)
            {
                ROTask = (ROTaskVSWCriteriaLoad)TaskListProperties.Tasks[taskParameters.Sequence];
            }
            else
            {
                ...
                ROTask = new ROTaskVSWCriteriaLoad(
                    task: task,
        ...
        private void AddValues(ROTaskParms taskParameters, ROTaskVSWCriteriaLoad task)
        {
        ...
        {
            successful = true;
            ROTaskVSWCriteriaLoad taskVSWCriteriaLoadData = (ROTaskVSWCriteriaLoad)taskData;
            ...
            if (!SetTask(taskData: taskVSWCriteriaLoadData, message: ref message))
            {
                successful = false;
            }
        ...
        private bool SetTask(
            ROTaskVSWCriteriaLoad taskData, 
            ref string message
            )
        {
