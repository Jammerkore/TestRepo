...
{
    public class TaskBatchCompute : TaskBase
    {
        //=======
        // FIELDS
        //=======
        ...
        {
            ROTaskBatchCompute ROTask = null;
            ...
            if (taskParameters.Sequence < TaskListProperties.Tasks.Count
                && TaskListProperties.Tasks[taskParameters.Sequence] is ROTaskBatchCompute)
            {
                ROTask = (ROTaskBatchCompute)TaskListProperties.Tasks[taskParameters.Sequence];
            }
            else
            {
        ...
        private void AddValues(ROTaskParms taskParameters, ROTaskBatchCompute task)
        {
        ...
        {
            successful = true;
            ROTaskBatchCompute BatchComputeData = (ROTaskBatchCompute)taskData;

            if (!SetTask(taskData: BatchComputeData, message: ref message))
            {
                successful = false;
            }
        ...
        override public bool TaskSaveData(
            ...
            ref string message)
        {
            scheduleDataLayer.TaskBatchComp_Insert(TaskData);
        ...
        {
            TaskData = ScheduleDataLayer.TaskBatchComp_ReadByTaskList(aTaskListRID: TaskListKey);
        }
    }
}
