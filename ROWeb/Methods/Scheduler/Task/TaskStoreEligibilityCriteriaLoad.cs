...
{
    public class TaskStoreEligibilityCriteriaLoad : TaskBase
    {
        //=======
        // FIELDS
        //=======
        ...
        // CONSTRUCTORS
        //=============
        public TaskStoreEligibilityCriteriaLoad(
        ...
        {
            ROTaskStoreEligibilityCriteriaLoad ROTask = null;
            ...
            if (taskParameters.Sequence < TaskListProperties.Tasks.Count
                && TaskListProperties.Tasks[taskParameters.Sequence] is ROTaskStoreEligibilityCriteriaLoad)
            {
                ROTask = (ROTaskStoreEligibilityCriteriaLoad)TaskListProperties.Tasks[taskParameters.Sequence];
            }
            else
            {
                ...
                ROTask = new ROTaskStoreEligibilityCriteriaLoad(
                    task: task,
        ...
        private string TaskDirectory => string.IsNullOrEmpty(MIDConfigurationManager.AppSettings["FileDirectory"]) ? @"C:\Logility\ROData\Channel Eligibility" :
                    string.Concat(MIDConfigurationManager.AppSettings["FileDirectory"], @"\Channel Eligibility");
            ...
            )
        {
            ...
            if (!SetTask(taskData: taskStoreEligibilityCriteriaLoadData, message: ref message))
            {
                successful = false;
            }
        ...
        private bool SetTask(
            ROTaskStoreEligibilityCriteriaLoad taskData, 
            ref string message
            )
        {
