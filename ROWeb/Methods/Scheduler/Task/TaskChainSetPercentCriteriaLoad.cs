...
{
    public class TaskChainSetPercentCriteriaLoad : TaskBase
    {
        //=======
        // FIELDS
        //=======
        ...
        // CONSTRUCTORS
        //=============
        public TaskChainSetPercentCriteriaLoad(
        ...
        {
            ROTaskChainSetPercentCriteriaLoad ROTask = null;
            ...
            if (taskParameters.Sequence < TaskListProperties.Tasks.Count
                && TaskListProperties.Tasks[taskParameters.Sequence] is ROTaskChainSetPercentCriteriaLoad)
            {
                ROTask = (ROTaskChainSetPercentCriteriaLoad)TaskListProperties.Tasks[taskParameters.Sequence];
            }
            else
            {
                ...
                ROTask = new ROTaskChainSetPercentCriteriaLoad(
                    task: task,
        ...
        private void AddValues(ROTaskParms taskParameters, ROTaskChainSetPercentCriteriaLoad task)
        {
        ...
        {
            successful = true;
            ROTaskChainSetPercentCriteriaLoad taskChainSetPercentCriteriaLoadData = (ROTaskChainSetPercentCriteriaLoad)taskData;

            if (!SetTask(taskData: taskChainSetPercentCriteriaLoadData, message: ref message))
            {
                successful = false;
            }
        ...
        private bool SetTask(
            ROTaskChainSetPercentCriteriaLoad taskData, 
            ref string message
            )
        {
