...
namespace Logility.ROWeb
{
    public class TaskSizeDayToWeekSummary : TaskBase
    {
            ...
            )
        {
            ...
            ROTaskSizeDayToWeekSummary ROTask = new ROTaskSizeDayToWeekSummary(
                task: task,
        ...
        {
            _taskData = DataLayerSchedule.TaskSizeDayToWeekSummary_ReadByTaskList(aTaskListRID: TaskListKey);
        }
    }
}
