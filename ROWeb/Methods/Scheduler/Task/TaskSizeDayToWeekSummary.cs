...
{
    public class TaskSizeDayToWeekSummary : TaskBase
    {
        //=======
        // FIELDS
        //=======
        ...
        // CONSTRUCTORS
        //=============
        public TaskSizeDayToWeekSummary(
        ...
        {
            ROTaskSizeDayToWeekSummary ROTask = null;
            ...
            if (taskParameters.Sequence < TaskListProperties.Tasks.Count
                && TaskListProperties.Tasks[taskParameters.Sequence] is ROTaskSizeDayToWeekSummary)
            {
                ROTask = (ROTaskSizeDayToWeekSummary)TaskListProperties.Tasks[taskParameters.Sequence];
            }
            else
            {
                ...
                ROTask = new ROTaskSizeDayToWeekSummary(
                    task: task,
        ...
        private void AddValues(ROTaskParms taskParameters, ROTaskSizeDayToWeekSummary task)
        {
        ...
        {
            successful = true;
            ROTaskSizeDayToWeekSummary taskSizeDayToWeekSummaryData = (ROTaskSizeDayToWeekSummary)taskData;
            ...
            if (!SetTask(taskData: taskSizeDayToWeekSummaryData, message: ref message))
            {
                successful = false;
            }
        ...
        private bool SetTask(
            ROTaskSizeDayToWeekSummary taskData, 
            ref string message
            )
        {
        ...
        {
            TaskData = ScheduleDataLayer.TaskSizeDayToWeekSummary_ReadByTaskList(aTaskListRID: TaskListKey);
        }
    }
}
