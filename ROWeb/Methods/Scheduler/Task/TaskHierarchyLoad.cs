...
{
    public class TaskHierarchyLoad : TaskBase
    {
        //=======
        // FIELDS
        //=======
        ...
        {
            ROTaskHierarchyLoad ROTask = null;
            ...
            if (taskParameters.Sequence < TaskListProperties.Tasks.Count
                && TaskListProperties.Tasks[taskParameters.Sequence] is ROTaskHierarchyLoad)
            {
                ROTask = (ROTaskHierarchyLoad)TaskListProperties.Tasks[taskParameters.Sequence];
            }
            else
            {
                ...
                ROTask = new ROTaskHierarchyLoad(
                    task: task,
        ...
        private void AddValues(ROTaskParms taskParameters, ROTaskHierarchyLoad task)
        {
        ...
        {
            successful = true;
            ROTaskHierarchyLoad taskHierarchyLoadData = (ROTaskHierarchyLoad)taskData;
            ...
            if (!SetTask(taskData: taskHierarchyLoadData, message: ref message))
            {
                successful = false;
            }
