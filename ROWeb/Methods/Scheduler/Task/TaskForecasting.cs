...
namespace Logility.ROWeb
{
    public class TaskForecasting : TaskBase
    {
            ...
            )
        {
            ...
            ROTaskForecasting ROTask = new ROTaskForecasting(
                task: task,
        ...
        {
            _taskData = DataLayerSchedule.TaskForecast_ReadByTaskList(aTaskListRID: TaskListKey);
            _taskDetailData = DataLayerSchedule.TaskForecastDetail_ReadByTaskList(aTaskListRID: TaskListKey);
        }
    }
}
