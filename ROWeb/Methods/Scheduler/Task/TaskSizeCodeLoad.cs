...
{
    public class TaskSizeCodeLoad : TaskBase
    {
        //=======
        // FIELDS
        //=======
        ...
        {
            ROTaskSizeCodeLoad ROTask = null;
            ...
            if (taskParameters.Sequence < TaskListProperties.Tasks.Count
                && TaskListProperties.Tasks[taskParameters.Sequence] is ROTaskSizeCodeLoad)
            {
                ROTask = (ROTaskSizeCodeLoad)TaskListProperties.Tasks[taskParameters.Sequence];
            }
            else
            {
        ...
        private void AddValues(ROTaskParms taskParameters, ROTaskSizeCodeLoad task)
        {
        ...
        {
            successful = true;
            ROTaskSizeCodeLoad taskSizeCodeLoadData = (ROTaskSizeCodeLoad)taskData;
            ...
            if (!SetTask(taskData: taskSizeCodeLoadData, message: ref message))
            {
                successful = false;
            }
