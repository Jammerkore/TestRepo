...
{
    public class TaskSizeCurves : TaskBase
    {
        //=======
        // FIELDS
        //=======
            ...
            )
        {
            ...
            if (taskParameters.Sequence < TaskListProperties.Tasks.Count
                && TaskListProperties.Tasks[taskParameters.Sequence] is ROTaskSizeCurves)
            {
                ROTask = (ROTaskSizeCurves)TaskListProperties.Tasks[taskParameters.Sequence];
            }
            else
            {
        ...
        {
            successful = true;
            ROTaskSizeCurves taskSizeCurvesData = (ROTaskSizeCurves)taskData;
            ...
            if (!SetTask(taskData: taskSizeCurvesData, message: ref message))
            {
                successful = false;
            }
        ...
        override public bool TaskSaveData(
            ...
            ref string message)
        {
            scheduleDataLayer.TaskSizeCurves_Insert(TaskData);
            scheduleDataLayer.TaskSizeCurveGenerateNode_Insert(TaskDetailData);
        ...
        {
            TaskData = ScheduleDataLayer.TaskSizeCurves_ReadByTaskList(aTaskListRID: TaskListKey);
            TaskDetailData = ScheduleDataLayer.TaskSizeCurveGenerateNode_ReadByTaskList(aTaskListRID: TaskListKey);
        }
    }
}
