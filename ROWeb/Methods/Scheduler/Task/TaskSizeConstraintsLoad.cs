...
{
    public class TaskSizeConstraintsLoad : TaskBase
    {
        //=======
        // FIELDS
        //=======
        ...
        // CONSTRUCTORS
        //=============
        public TaskSizeConstraintsLoad(
        ...
        {
            ROTaskSizeConstraintsLoad ROTask = null;
            ...
            if (taskParameters.Sequence < TaskListProperties.Tasks.Count
                && TaskListProperties.Tasks[taskParameters.Sequence] is ROTaskSizeConstraintsLoad)
            {
                ROTask = (ROTaskSizeConstraintsLoad)TaskListProperties.Tasks[taskParameters.Sequence];
            }
            else
            {
                ...
                ROTask = new ROTaskSizeConstraintsLoad(
                    task: task,
        ...
        private void AddValues(ROTaskParms taskParameters, ROTaskSizeConstraintsLoad task)
        {
        ...
        {
            successful = true;
            ROTaskSizeConstraintsLoad taskSizeConstraintsLoadData = (ROTaskSizeConstraintsLoad)taskData;
            ...
            if (!SetTask(taskData: taskSizeConstraintsLoadData, message: ref message))
            {
                successful = false;
            }
        ...
        private bool SetTask(
            ROTaskSizeConstraintsLoad taskData, 
            ref string message
            )
        {
