...
namespace Logility.ROWeb
{
    public class TaskRelieveIntransit : TaskBase
    {
        ...
        {
            ROTaskRelieveIntransit ROTask = null;
            ...
            if (taskParameters.Sequence < TaskListProperties.Tasks.Count
                && TaskListProperties.Tasks[taskParameters.Sequence] is ROTaskRelieveIntransit)
            {
                ROTask = (ROTaskRelieveIntransit)TaskListProperties.Tasks[taskParameters.Sequence];
            }
            else
            {
                ...
                ROTask = new ROTaskRelieveIntransit(
                    task: task,
