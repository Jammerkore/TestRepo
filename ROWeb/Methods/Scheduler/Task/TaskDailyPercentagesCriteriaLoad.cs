...
{
    public class TaskDailyPercentagesCriteriaLoad : TaskBase
    {
        //=======
        // FIELDS
        //=======
        ...
        // CONSTRUCTORS
        //=============
        public TaskDailyPercentagesCriteriaLoad(
        ...
        {
            ROTaskDailyPercentagesCriteriaLoad ROTask = null;
            ...
            if (taskParameters.Sequence < TaskListProperties.Tasks.Count
                && TaskListProperties.Tasks[taskParameters.Sequence] is ROTaskDailyPercentagesCriteriaLoad)
            {
                ROTask = (ROTaskDailyPercentagesCriteriaLoad)TaskListProperties.Tasks[taskParameters.Sequence];
            }
            else
            {
                ...
                ROTask = new ROTaskDailyPercentagesCriteriaLoad(
                    task: task,
        ...
        private void AddValues(ROTaskParms taskParameters, ROTaskDailyPercentagesCriteriaLoad task)
        {
        ...
        private string TaskDirectory => string.IsNullOrEmpty(MIDConfigurationManager.AppSettings["FileDirectory"]) ? @"C:\Logility\ROData\Daily" :
                    string.Concat(MIDConfigurationManager.AppSettings["FileDirectory"], @"\Daily");
        ...
        private bool SetTask(
            ROTaskDailyPercentagesCriteriaLoad taskData, 
            ref string message
            )
        {
