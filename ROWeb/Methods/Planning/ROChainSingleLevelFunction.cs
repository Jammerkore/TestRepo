...
{
    public class ROChainSingleLevel : ROChainFunction
    {
        ...
        public ROChainSingleLevel(SessionAddressBlock SAB, ROWebTools ROWebTools)
            : base(SAB, ROWebTools)
        {
        ...
        override protected ROOut OpenCubeGroup(ROCubeOpenParms openParams)
        {
            ...
            if (openParams.VersionKey != Include.Undefined)
            {
                ...
                OpenParms.StoreHLPlanProfile.VersionProfile = GetVersionProfile(openParams.VersionKey, ePlanType.Store, ePlanBasisType.Plan);
            }
            else
            {
                OpenParms.ChainHLPlanProfile.VersionProfile = GetVersionProfile(openParams.sVersion, ePlanType.Chain, ePlanBasisType.Plan);
                OpenParms.StoreHLPlanProfile.VersionProfile = GetVersionProfile(openParams.sVersion, ePlanType.Store, ePlanBasisType.Plan);
            }
            OpenParms.DateRangeProfile = GetDateRangeProfile(openParams.cdrRID);
            OpenParms.FunctionSecurityProfile = GetFunctionSecurity(ePlanType.Chain, false);
            ...
            // find the Low Level Version Key 
            ...
            planManager = new ROPlanChainSingleLevelManager(SAB, OpenParms);
        ...
        {
            return ((ROPlanChainSingleLevelManager)planManager).ChainSingleLevelViewData is Logility.ROUI.ROChainSingleLevelLadderViewData ? iAddedColumnCount : 3;
        }
