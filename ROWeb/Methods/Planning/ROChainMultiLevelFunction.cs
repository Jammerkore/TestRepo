...
{
    public class ROChainMultiLevel : ROChainFunction
    {
        ...
        public ROChainMultiLevel(SessionAddressBlock SAB, ROWebTools ROWebTools)
            : base(SAB, ROWebTools)
        {
        ...
        override protected ROOut OpenCubeGroup(ROCubeOpenParms openParams)
        {
            ...
            OpenParms.SetSummaryDateProfile = true;
            ...
            planManager = new ROPlanChainMultiLevelManager(SAB, OpenParms);
        ...
        {
            ((ROPlanChainMultiLevelManager)planManager).PeriodChanged(periodChangeParams.bShowYears, periodChangeParams.bShowSeasons, periodChangeParams.bShowQuarters,
        ...
        override public ROOut SaveCubeGroup()
        {
            ...
            if (planSaveParms.SaveChainHighLevel)
            {
                ...
                planSaveParms.SaveLowLevelChainAsChain = false;
            }
