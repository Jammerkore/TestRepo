...
{
    public partial class ROMerchandiseExplorer : ROBaseExplorer
    {
        /// <summary>
        ...
        public ROMerchandiseExplorer(SessionAddressBlock SAB, ROWebTools ROWebTools)
            : base(SAB, ROWebTools)
		{
            _treeView = new HierarchyTreeView();
        }
        ...
        override public ROOut ProcessRequest(ROParms Parms)
        {
            ...
            {
                case eRORequest.GetMerchandiseExplorerData:
