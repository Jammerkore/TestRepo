...
namespace MIDRetail.Common
{
    public class DataTableTools
    {
        ...
        public static List<KeyValuePair<int, string>> DataTableToKeyValues(DataTable dataTable, string keyColName, string valueColName, bool includeusername = false)
        {
        ...
        public static DataTable SortDataTable(DataTable dataTable, string sColName, bool bAscending = true)
        {
