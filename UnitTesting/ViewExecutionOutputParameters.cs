...
{
    public partial class ViewExecutionOutputParameters : UserControl
    {
        public ViewExecutionOutputParameters()
        {
            InitializeComponent();
        }
        private void ultraGrid1_InitializeLayout(object sender, Infragistics.Win.UltraWinGrid.InitializeLayoutEventArgs e)
        {
            e.Layout.Bands[0].Columns["parameterName"].Header.Caption = "Output Parameter";
        ...
        private void ultraToolbarsManager1_ToolClick(object sender, Infragistics.Win.UltraWinToolbars.ToolClickEventArgs e)
        {
            switch (e.Tool.Key)
            {
                case "btnInsertOutputParameterMatching":
                    InsertOutputParameterMatching();
                    break;
        ...
        //    }
        //}
        private void InsertOutputParameterMatching()
        {
            //if (dtResultsShown.Rows.Count > 0)
            //{
                UnitTests.ExpectedResults_AddOutputParameterMatching(testName, procedureName, dsOutputParameters);
                RaiseInsertFromResultsEvent();
            //}
            //else
            //{
