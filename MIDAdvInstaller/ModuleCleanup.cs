...
namespace MIDRetailInstaller
{
    class ModuleCleanup
    {
        ...
        public ModuleCleanup()
        {
            ...
            // *                     WARNING                           * //
            // *                                                       * //
            // * Any changes to list must also be made to the          * //
            // * corresponding module in the AutoUpgrade project       * //
            // *                                                       * //
            ...
            preDeleteFiles.Add("Microsoft.Office.Interop.Outlook.dll");
            preDeleteFiles.Add("Microsoft.Office.Interop.Outlook.xml");
            preDeleteFiles.Add("office.dll");
            preDeleteFiles.Add("office.xml");
