...
//        public DataTable dtConditions;
//        public int filterRID;
//        public filterTypes filterType;
//        public string filterName;
//        public int userRID;
//        public int currentUserRID;
...
//        }
//        public void LoadConditionsFromDataRowArray(DataRow[] drConditions)
//        {
...
//            filterInfo.Seq = dtConditions.Rows.Count + 1;
...
//        {
//            int seq = fc.Seq;
//            DataRow[] drfind = dsConditions.Tables[0].Select("SEQ = " + seq.ToString());
...
//        {
//            DataRow[] drNextSiblings = dsConditions.Tables[0].Select("PARENT_SEQ = " + n.condition.ParentSeq.ToString() + " AND SIBLING_SEQ > " + n.condition.SiblingSeq.ToString(), "SIBLING_SEQ");
...
//        {
//            DataRow[] drSiblings = dsConditions.Tables[0].Select("PARENT_SEQ = " + n.condition.ParentSeq.ToString() + " AND SEQ <> " + n.condition.Seq.ToString());
...
//        {
//            DataRow[] drPrevSiblings = dsConditions.Tables[0].Select("PARENT_SEQ = " + n.condition.ParentSeq.ToString() + " AND SIBLING_SEQ < " + n.condition.SiblingSeq.ToString(), "SIBLING_SEQ");
...
//        {
//            DataRow[] drPrevSiblings = dsConditions.Tables[0].Select("PARENT_SEQ = " + parentSeq.ToString(), "SIBLING_SEQ");
//            if (drPrevSiblings.Length > 0)
//            {
...
//            DataRow[] drfind = dsConditions.Tables[0].Select("SEQ = " + seqToRemove.ToString());
...
//            DataRow[] drchildren = dsConditions.Tables[0].Select("PARENT_SEQ = " + seq.ToString());
