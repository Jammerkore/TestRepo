...
//        public static readonly storeFieldTypes StoreID = new storeFieldTypes(0, 900000, new valueInfoTypes(valueTypes.Text));
//        public static readonly storeFieldTypes StoreName = new storeFieldTypes(1, 900001, new valueInfoTypes(valueTypes.Text));
//        public static readonly storeFieldTypes ActiveInd = new storeFieldTypes(2, 900002, new valueInfoTypes(valueTypes.Boolean));
//        public static readonly storeFieldTypes City = new storeFieldTypes(3, 900003, new valueInfoTypes(valueTypes.Text));
//        public static readonly storeFieldTypes State = new storeFieldTypes(4, 900004, new valueInfoTypes(valueTypes.Text));
//        public static readonly storeFieldTypes SellingSqFt = new storeFieldTypes(5, 900005, new valueInfoTypes(valueTypes.Numeric, numericTypes.Integer));
//        public static readonly storeFieldTypes SellingOpenDate = new storeFieldTypes(6, 900006, new valueInfoTypes(valueTypes.Date, dateTypes.DateOnly));
//        public static readonly storeFieldTypes SellingCloseDate = new storeFieldTypes(7, 900007, new valueInfoTypes(valueTypes.Date, dateTypes.DateOnly));
//        public static readonly storeFieldTypes StockOpenDate = new storeFieldTypes(8, 900008, new valueInfoTypes(valueTypes.Date, dateTypes.DateOnly));
//        public static readonly storeFieldTypes StockCloseDate = new storeFieldTypes(9, 900009, new valueInfoTypes(valueTypes.Date, dateTypes.DateOnly));
//        public static readonly storeFieldTypes LeadTime = new storeFieldTypes(10, 900010, new valueInfoTypes(valueTypes.Numeric, numericTypes.Integer));
//        public static readonly storeFieldTypes ShipOnMonday = new storeFieldTypes(11, 900011, new valueInfoTypes(valueTypes.Boolean));
//        public static readonly storeFieldTypes ShipOnTuesday = new storeFieldTypes(12, 900012, new valueInfoTypes(valueTypes.Boolean));
//        public static readonly storeFieldTypes ShipOnWednesday = new storeFieldTypes(13, 900013, new valueInfoTypes(valueTypes.Boolean));
//        public static readonly storeFieldTypes ShipOnThursday = new storeFieldTypes(14, 900014, new valueInfoTypes(valueTypes.Boolean));
//        public static readonly storeFieldTypes ShipOnFriday = new storeFieldTypes(15, 900015, new valueInfoTypes(valueTypes.Boolean));
//        public static readonly storeFieldTypes ShipOnSaturday = new storeFieldTypes(16, 900016, new valueInfoTypes(valueTypes.Boolean));
//        public static readonly storeFieldTypes ShipOnSunday = new storeFieldTypes(17, 900017, new valueInfoTypes(valueTypes.Boolean));
//        public static readonly storeFieldTypes StoreDescription = new storeFieldTypes(18, 900024, new valueInfoTypes(valueTypes.Text));
//        public static readonly storeFieldTypes SimiliarStoreModel = new storeFieldTypes(19, 900352, new valueInfoTypes(valueTypes.Text));
//        public static readonly storeFieldTypes ImoID = new storeFieldTypes(20, 900805, new valueInfoTypes(valueTypes.Text));
//        public static readonly storeFieldTypes StockLeadWeeks = new storeFieldTypes(21, 900820, new valueInfoTypes(valueTypes.Numeric, numericTypes.Integer));



//        private storeFieldTypes(int dbIndex, int textCode, valueInfoTypes valueInfoType)
//        {
