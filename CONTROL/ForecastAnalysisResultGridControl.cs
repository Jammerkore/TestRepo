...
{
    public partial class ForecastAnalysisResultGridControl : UserControl
    {
        public ForecastAnalysisResultGridControl()
        {
            InitializeComponent();
        }
        ...
        private void ForecastAnalysisResultGrid_Load(object sender, EventArgs e)
        {
