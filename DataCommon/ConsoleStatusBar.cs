...
namespace MIDRetail.DataCommon
{
    public class ConsoleStatusBar
    {
        ...
        public void OverwriteConsoleMessage(string message)
        {
        ...
        public void RenderConsoleProgress(int percentage)
        {
        ...
        public void RenderConsoleProgress(int percentage, char progressBarCharacter,
