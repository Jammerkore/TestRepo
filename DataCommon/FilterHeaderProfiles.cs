...
{
	[Serializable]
	public class HeaderFilterProfile : Profile, ICloneable
	{
		//=======
		// FIELDS
		//=======
		...
		public HeaderFilterProfile(int aKey)
			: base(aKey)
		{
			_name = "";
			_userRID = 0;
		...
		public HeaderFilterProfile(DataRow aRow)
			: base(-1)
		{
...
//			_userRID = aUserRID;
//		}
        private HeaderFilterProfile(int aKey, string aName, int aUserRID, int aOwnerUserRID, bool isLimited, int resultLimit)
			: base(aKey)
		{
			_name = aName;
			_userRID = aUserRID;
		...
		override public eProfileType ProfileType
		{
			get
			{
				return eProfileType.FilterHeader;
			}
		}
...
//		}
		public object Clone()
		{
            return new HeaderFilterProfile(_key, _name, _userRID, _ownerUserRID, _isLimited, _resultLimit);
		}
		//End Track #4815
