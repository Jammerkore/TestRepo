...
{
	[Serializable]
	public class AssortmentFilterProfile : Profile, ICloneable
	{
		//=======
		// FIELDS
		//=======
		...
		public AssortmentFilterProfile(int aKey)
			: base(aKey)
		{
			_name = "";
			_userRID = 0;
		...
		public AssortmentFilterProfile(DataRow aRow)
			: base(-1)
		{
...
//			_userRID = aUserRID;
//		}
        private AssortmentFilterProfile(int aKey, string aName, int aUserRID, int aOwnerUserRID, bool isLimited, int resultLimit)
			: base(aKey)
		{
			_name = aName;
			_userRID = aUserRID;
		...
		override public eProfileType ProfileType
		{
			get
			{
				return eProfileType.FilterAssortment;
			}
		}
...
//		}
		public object Clone()
		{
            return new AssortmentFilterProfile(_key, _name, _userRID, _ownerUserRID, _isLimited, _resultLimit);
		}
		//End Track #4815
