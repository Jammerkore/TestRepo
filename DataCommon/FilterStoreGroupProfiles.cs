...
{
	[Serializable]
	public class StoreGroupFilterProfile : Profile, ICloneable
	{
		//=======
		// FIELDS
		//=======
		...
		public StoreGroupFilterProfile(int aKey)
			: base(aKey)
		{
			_name = "";
			_userRID = 0;
		...
		public StoreGroupFilterProfile(DataRow aRow)
			: base(-1)
		{
...
//			_userRID = aUserRID;
//		}
        private StoreGroupFilterProfile(int aKey, string aName, int aUserRID, int aOwnerUserRID, bool isLimited, int resultLimit)
			: base(aKey)
		{
			_name = aName;
			_userRID = aUserRID;
		...
		override public eProfileType ProfileType
		{
			get
			{
				return eProfileType.FilterStoreGroup;
			}
		}
...
//		}
		public object Clone()
		{
            return new StoreGroupFilterProfile(_key, _name, _userRID, _ownerUserRID, _isLimited, _resultLimit);
		}
		//End Track #4815
