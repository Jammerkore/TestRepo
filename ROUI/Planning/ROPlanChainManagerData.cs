...
namespace Logility.ROUI
{
    ...
    /// </summary>
    abstract public class ROPlanChainManagerData : ROPlanManagerData
    {

        public ROPlanChainManagerData(SessionAddressBlock aSAB, PlanOpenParms aOpenParms)
    ...
    /// </summary>
    abstract public class ROChainViewData : ROPlanViewData
    {
