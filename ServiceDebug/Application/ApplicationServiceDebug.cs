...
namespace MIDRetail.ServiceDebug.Application
{
	/// <summary>
	/// Summary description for Class1.
	/// </summary>
	class ApplicationServiceDebug
	{
		...
		static void Main(string[] args)
		{
			...
			appThread = new Thread(new ThreadStart(ApplicationThread));
		...
		static public void ApplicationThread()
		{
			// Configure Remoting
			...
			{
				System.Console.WriteLine("Error registering ApplicationServiceSession - " + e.Message);
				return;
			}
			...
			System.Console.WriteLine("MIDApplicationService started successfully and listening on port #" + _port);
		}
	}
}
