...
{
	public class AssortmentComponentPlaceholderGrade : AssortmentComponentPlaceholderCube
	{
		//=======
		// FIELDS
		//=======
		...
		public AssortmentComponentPlaceholderGrade(SessionAddressBlock aSAB, ApplicationSessionTransaction aTransaction, AssortmentCubeGroup aAssrtCubeGroup, CubeDefinition aCubeDefinition, int aCubePriority, bool aReadOnly, bool aCheckNodeSecurity)
		...
		{
			return new eCubeType(eCubeType.cAssortmentComponentPlaceholderGradeSubTotal, AssortmentCubeGroup.NumberOfSummaryLevels);
		}
		...
		override public string GetCellDescription(ComputationCellReference aCompCellRef)
		{
			...
			try
			{
				...
				return "Assortment Component Placeholder Grade" +
