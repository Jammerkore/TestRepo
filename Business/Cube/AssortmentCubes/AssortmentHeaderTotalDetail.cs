...
{
	public class AssortmentHeaderTotalDetail : AssortmentCube
	{
		//=======
		// FIELDS
		//=======
		...
		public AssortmentHeaderTotalDetail(SessionAddressBlock aSAB, ApplicationSessionTransaction aTransaction, AssortmentCubeGroup aAssrtCubeGroup, CubeDefinition aCubeDefinition, int aCubePriority, bool aReadOnly, bool aCheckNodeSecurity)
		...
		override public eCubeType CubeType
		{
			get
			{
				return eCubeType.AssortmentHeaderTotalDetail;
			}
		}
		...
		override public string GetCellDescription(ComputationCellReference aCompCellRef)
		{
			...
			try
			{
				...
				return "Assortment Header Total Detail" +
