...
{
	abstract public class AssortmentComponentHeaderCube : AssortmentComponentCube
	{
		//=============
		// CONSTRUCTORS
		//=============
		...
		public AssortmentComponentHeaderCube(SessionAddressBlock aSAB, ApplicationSessionTransaction aTransaction, AssortmentCubeGroup aAssrtCubeGroup, CubeDefinition aCubeDefinition, ushort aCubeAttributes, int aCubePriority, bool aReadOnly, bool aCheckNodeSecurity)
