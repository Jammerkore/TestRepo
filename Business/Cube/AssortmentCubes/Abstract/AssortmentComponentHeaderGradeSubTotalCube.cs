...
{
	abstract public class AssortmentComponentHeaderGradeSubTotalCube : AssortmentComponentGradeSubTotalCube
	{
		//=============
		// CONSTRUCTORS
		//=============
		...
		public AssortmentComponentHeaderGradeSubTotalCube(SessionAddressBlock aSAB, ApplicationSessionTransaction aTransaction, AssortmentCubeGroup aAssrtCubeGroup, CubeDefinition aCubeDefinition, int aCubePriority, bool aReadOnly, bool aCheckNodeSecurity, eCubeType aCubeType, eCubeType aSubTotalCubeType)
