...
{
	abstract public class AssortmentComponentPlaceholderGroupLevelSubTotalCube : AssortmentComponentGroupLevelSubTotalCube
	{
		//=============
		// CONSTRUCTORS
		//=============
		...
		public AssortmentComponentPlaceholderGroupLevelSubTotalCube(SessionAddressBlock aSAB, ApplicationSessionTransaction aTransaction, AssortmentCubeGroup aAssrtCubeGroup, CubeDefinition aCubeDefinition, int aCubePriority, bool aReadOnly, bool aCheckNodeSecurity, eCubeType aCubeType, eCubeType aSubTotalCubeType)
