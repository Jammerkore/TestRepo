...
{
	abstract public class AssortmentComponentHeaderTotalSubTotalCube : AssortmentComponentTotalSubTotalCube
	{
		//=============
		// CONSTRUCTORS
		//=============
		...
		public AssortmentComponentHeaderTotalSubTotalCube(SessionAddressBlock aSAB, ApplicationSessionTransaction aTransaction, AssortmentCubeGroup aAssrtCubeGroup, CubeDefinition aCubeDefinition, int aCubePriority, bool aReadOnly, bool aCheckNodeSecurity, eCubeType aCubeType, eCubeType aSubTotalCubeType)
