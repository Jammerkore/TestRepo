...
{
	abstract public class AssortmentComponentHeaderGroupLevelSubTotalCube : AssortmentComponentGroupLevelSubTotalCube
	{
		//=============
		// CONSTRUCTORS
		//=============
		...
		public AssortmentComponentHeaderGroupLevelSubTotalCube(SessionAddressBlock aSAB, ApplicationSessionTransaction aTransaction, AssortmentCubeGroup aAssrtCubeGroup, CubeDefinition aCubeDefinition, int aCubePriority, bool aReadOnly, bool aCheckNodeSecurity, eCubeType aCubeType, eCubeType aSubTotalCubeType)
