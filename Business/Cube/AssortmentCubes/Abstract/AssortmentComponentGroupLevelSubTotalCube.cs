...
{
	abstract public class AssortmentComponentGroupLevelSubTotalCube : AssortmentComponentSubTotalCube
	{
		//=======
		// FIELDS
		//=======
		...
		public AssortmentComponentGroupLevelSubTotalCube(SessionAddressBlock aSAB, ApplicationSessionTransaction aTransaction, AssortmentCubeGroup aAssrtCubeGroup, CubeDefinition aCubeDefinition, int aCubePriority, bool aReadOnly, bool aCheckNodeSecurity, eCubeType aCubeType, eCubeType aSubTotalCubeType)
			: base(aSAB, aTransaction, aAssrtCubeGroup, aCubeDefinition, PlanCubeAttributesFlagValues.GroupTotal, aCubePriority, aReadOnly, aCheckNodeSecurity, aCubeType.Level, aCubeType, aSubTotalCubeType)
		{
		}
