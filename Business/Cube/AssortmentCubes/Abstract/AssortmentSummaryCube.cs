...
{
	abstract public class AssortmentSummaryCube : AssortmentCube
	{
		//=============
		// CONSTRUCTORS
		//=============
		...
		public AssortmentSummaryCube(SessionAddressBlock aSAB, ApplicationSessionTransaction aTransaction, AssortmentCubeGroup aAssrtCubeGroup, CubeDefinition aCubeDefinition, ushort aCubeAttributes, int aCubePriority, bool aReadOnly, bool aCheckNodeSecurity)
