...
{
	public class AssortmentPlaceholderGradeTotal : AssortmentComponentPlaceholderCube
	{
		//=======
		// FIELDS
		//=======
		...
		public AssortmentPlaceholderGradeTotal(SessionAddressBlock aSAB, ApplicationSessionTransaction aTransaction, AssortmentCubeGroup aAssrtCubeGroup, CubeDefinition aCubeDefinition, int aCubePriority, bool aReadOnly, bool aCheckNodeSecurity)
		...
		public override eCubeType CubeType
		{
			get
			{
				return eCubeType.AssortmentPlaceholderGradeTotal;
			}
		}
