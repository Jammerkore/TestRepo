...
{
	public class AssortmentComponentHeaderGradeSubTotal : AssortmentComponentHeaderGradeSubTotalCube
	{
		//=======
		// FIELDS
		//=======
		...
		public AssortmentComponentHeaderGradeSubTotal(SessionAddressBlock aSAB, ApplicationSessionTransaction aTransaction, AssortmentCubeGroup aAssrtCubeGroup, CubeDefinition aCubeDefinition, int aCubePriority, bool aReadOnly, bool aCheckNodeSecurity, eCubeType aCubeType, eCubeType aSubTotalCubeType)
		...
		override public eCubeType GetSubTotalCubeType()
		{
			...
			if (Level > 1)		//TT#621-MD - stodd - post assortment gets a "Dimension not defined on cube" error
			{
				...
				{
					return new eCubeType(eCubeType.cAssortmentComponentHeaderGradeSubTotal, Level - 1);
				}
				else
				{
			...
			else
			{
				...
				//return SubTotalCubeType;
				// END TT#657-MD - Stodd - Total % displays as zero for Headers on Post-Receipt Assortment
				//ND TT#621-MD - stodd - post assortment gets a "Dimension not defined on cube" error
			}
			//return SubTotalCubeType;
		...
		override public string GetCellDescription(ComputationCellReference aCompCellRef)
		{
			...
			try
			{
				...
				return "Assortment Component Header Grade SubTotal" +
