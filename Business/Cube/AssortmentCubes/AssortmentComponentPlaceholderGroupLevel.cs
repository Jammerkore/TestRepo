...
{
	public class AssortmentComponentPlaceholderGroupLevel : AssortmentComponentPlaceholderCube
	{
		//=======
		// FIELDS
		//=======
		...
		public AssortmentComponentPlaceholderGroupLevel(SessionAddressBlock aSAB, ApplicationSessionTransaction aTransaction, AssortmentCubeGroup aAssrtCubeGroup, CubeDefinition aCubeDefinition, int aCubePriority, bool aReadOnly, bool aCheckNodeSecurity)
		...
		{
			return new eCubeType(eCubeType.cAssortmentComponentPlaceholderGroupLevelSubTotal, AssortmentCubeGroup.NumberOfSummaryLevels);
		}
