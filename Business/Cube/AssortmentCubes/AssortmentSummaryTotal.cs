...
{
	public class AssortmentSummaryTotal : AssortmentSummaryCube
	{
		//=======
		// FIELDS
		//=======
		...
		public AssortmentSummaryTotal(SessionAddressBlock aSAB, ApplicationSessionTransaction aTransaction, AssortmentCubeGroup aAssrtCubeGroup, CubeDefinition aCubeDefinition, int aCubePriority, bool aReadOnly, bool aCheckNodeSecurity)
		...
		override public string GetCellDescription(ComputationCellReference aCompCellRef)
		{
			...
			try
			{
				...
				return "Assortment Summary Total" +
