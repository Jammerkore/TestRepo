...
{
	/// <summary>
	/// This class defines the PlanPlanLowLevelTotalWeekDetail.
	/// </summary>
	/// <remarks>
	/// The PlanPlanLowLevelTotalWeekDetail defines the values for the sum of the time periods for a variable.
	/// </remarks>

	abstract public class PlanPlanLowLevelTotalWeekDetailCube : PlanPlanWeekDetailCube
	{
		//=======
		// FIELDS
		//=======
		...
		/// <summary>
		/// Creates a new instance of PlanPlanLowLevelTotalWeekDetail, using the given SessionAddressBlock, Transaction, and PlanCubeGroup.
		/// </summary>
		/// <param name="aSAB">
		/// A reference to a SessionAddressBlock that this PlanPlanLowLevelTotalWeekDetail is a part of.
		/// </param>
		/// <param name="aTransaction">
		/// A reference to a Transaction that this PlanPlanLowLevelTotalWeekDetail is a part of.
		/// </param>
		/// <param name="aPlanCubeGroup">
		/// A reference to a PlanCubeGroup that this PlanPlanLowLevelTotalWeekDetail is a part of.
		/// </param>

		public PlanPlanLowLevelTotalWeekDetailCube(
		...
		override public bool isVersionProtected(PlanCellReference aPlanCellRef)
		{
			...
			{
				//Begin Track #6008 - JScott - B OTB Multi Level Errors Copy Low to High and Balance Low Levels
				//hashValue = _versionProtectedHash[aPlanCellRef[eProfileType.Week]];
				hashKey = new HashKeyObject(aPlanCellRef[eProfileType.LowLevelTotalVersion], aPlanCellRef[eProfileType.Week], aPlanCellRef[eProfileType.Variable]);
				...
				if (hashValue == null)
				{
					...
					//Begin Track #6008 - JScott - B OTB Multi Level Errors Copy Low to High and Balance Low Levels
					//_versionProtectedHash[aPlanCellRef[eProfileType.Week]] = isProtected;
