...
{
	/// <summary>
	/// This class defines the StoreBasisLowLevelTotalGroupTotalPeriodDetail.
	/// </summary>
	/// <remarks>
	/// The StoreBasisLowLevelTotalGroupTotalPeriodDetail defines the values for the sum of the time periods for a variable.
	/// </remarks>

	public class StoreBasisLowLevelTotalGroupTotalPeriodDetail : PlanBasisLowLevelTotalPeriodDetailCube
	{
		//=======
		// FIELDS
		//=======
		...
		/// <summary>
		/// Creates a new instance of StoreBasisLowLevelTotalGroupTotalPeriodDetail, using the given SessionAddressBlock, Transaction, and PlanCubeGroup.
		/// </summary>
		/// <param name="aSAB">
		/// A reference to a SessionAddressBlock that this StoreBasisLowLevelTotalGroupTotalPeriodDetail is a part of.
		/// </param>
		/// <param name="aTransaction">
		/// A reference to a Transaction that this StoreBasisLowLevelTotalGroupTotalPeriodDetail is a part of.
		/// </param>
		/// <param name="aPlanCubeGroup">
		/// A reference to a PlanCubeGroup that this StoreBasisLowLevelTotalGroupTotalPeriodDetail is a part of.
		/// </param>

		public StoreBasisLowLevelTotalGroupTotalPeriodDetail(
		...
		override public string GetCellDescription(ComputationCellReference aCompCellRef)
		{
			...
			try
			{
				...
				return "Store Basis Low Level Total Group Total Period Detail" +
