...
{
	/// <summary>
	/// This class defines the StoreBasisGroupTotalDateTotal.
	/// </summary>
	/// <remarks>
	/// The StoreBasisGroupTotalDateTotal defines the values for the sum of the time periods for a variable.
	/// </remarks>

	public class StoreBasisGroupTotalDateTotal : PlanBasisDateTotalCube
	{
		//=======
		// FIELDS
		//=======
		...
		/// <summary>
		/// Creates a new instance of StoreBasisGroupTotalDateTotal, using the given SessionAddressBlock, Transaction, and PlanCubeGroup.
		/// </summary>
		/// <param name="aSAB">
		/// A reference to a SessionAddressBlock that this StoreBasisGroupTotalDateTotal is a part of.
		/// </param>
		/// <param name="aTransaction">
		/// A reference to a Transaction that this StoreBasisGroupTotalDateTotal is a part of.
		/// </param>
		/// <param name="aPlanCubeGroup">
		/// A reference to a PlanCubeGroup that this StoreBasisGroupTotalDateTotal is a part of.
		/// </param>

		public StoreBasisGroupTotalDateTotal(
