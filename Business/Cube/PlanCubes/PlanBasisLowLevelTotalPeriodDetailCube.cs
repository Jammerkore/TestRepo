...
{
	/// <summary>
	/// This class defines the PlanBasisLowLevelTotalPeriodDetail.
	/// </summary>
	/// <remarks>
	/// The PlanBasisLowLevelTotalPeriodDetail defines the values for the sum of the time periods for a variable.
	/// </remarks>

	abstract public class PlanBasisLowLevelTotalPeriodDetailCube : PlanBasisPeriodDetailCube
	{
		//=======
		// FIELDS
		//=======
		...
		/// <summary>
		/// Creates a new instance of PlanBasisLowLevelTotalPeriodDetail, using the given SessionAddressBlock, Transaction, and PlanCubeGroup.
		/// </summary>
		/// <param name="aSAB">
		/// A reference to a SessionAddressBlock that this PlanBasisLowLevelTotalPeriodDetail is a part of.
		/// </param>
		/// <param name="aTransaction">
		/// A reference to a Transaction that this PlanBasisLowLevelTotalPeriodDetail is a part of.
		/// </param>
		/// <param name="aPlanCubeGroup">
		/// A reference to a PlanCubeGroup that this PlanBasisLowLevelTotalPeriodDetail is a part of.
		/// </param>

		public PlanBasisLowLevelTotalPeriodDetailCube(
