...
{
	/// <summary>
	/// This class defines the StorePlanLowLevelTotalGroupTotalWeekDetail.
	/// </summary>
	/// <remarks>
	/// The StorePlanLowLevelTotalGroupTotalWeekDetail defines the values for the sum of the time periods for a variable.
	/// </remarks>

	public class StorePlanLowLevelTotalGroupTotalWeekDetail : PlanPlanLowLevelTotalWeekDetailCube
	{
		//=======
		// FIELDS
		//=======
		...
		/// <summary>
		/// Creates a new instance of StorePlanLowLevelTotalGroupTotalWeekDetail, using the given SessionAddressBlock, Transaction, and PlanCubeGroup.
		/// </summary>
		/// <param name="aSAB">
		/// A reference to a SessionAddressBlock that this StorePlanLowLevelTotalGroupTotalWeekDetail is a part of.
		/// </param>
		/// <param name="aTransaction">
		/// A reference to a Transaction that this StorePlanLowLevelTotalGroupTotalWeekDetail is a part of.
		/// </param>
		/// <param name="aPlanCubeGroup">
		/// A reference to a PlanCubeGroup that this StorePlanLowLevelTotalGroupTotalWeekDetail is a part of.
		/// </param>

		public StorePlanLowLevelTotalGroupTotalWeekDetail(
		...
		override public string GetCellDescription(ComputationCellReference aCompCellRef)
		{
			...
			try
			{
				...
				return "Store Plan Low-Level Total Group Total Week Detail" +
					", Node \"" + nodeProf.Text + "\"" +
