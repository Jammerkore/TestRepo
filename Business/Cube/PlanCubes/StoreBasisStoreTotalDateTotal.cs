...
{
	/// <summary>
	/// This class defines the StoreBasisStoreTotalDateTotal.
	/// </summary>
	/// <remarks>
	/// The StoreBasisStoreTotalDateTotal defines the values for the sum of the time periods for a variable.
	/// </remarks>

	public class StoreBasisStoreTotalDateTotal : PlanBasisDateTotalCube
	{
		//=======
		// FIELDS
		//=======
		...
		/// <summary>
		/// Creates a new instance of StoreBasisStoreTotalDateTotal, using the given SessionAddressBlock, Transaction, and PlanCubeGroup.
		/// </summary>
		/// <param name="aSAB">
		/// A reference to a SessionAddressBlock that this StoreBasisStoreTotalDateTotal is a part of.
		/// </param>
		/// <param name="aTransaction">
		/// A reference to a Transaction that this StoreBasisStoreTotalDateTotal is a part of.
		/// </param>
		/// <param name="aPlanCubeGroup">
		/// A reference to a PlanCubeGroup that this StoreBasisStoreTotalDateTotal is a part of.
		/// </param>

		public StoreBasisStoreTotalDateTotal(
		...
		override public string GetCellDescription(ComputationCellReference aCompCellRef)
		{
			...
			try
			{
				...
				return "Store Basis Store Total Date Total" +
					", Node \"" + nodeProf.Text + "\"" +
