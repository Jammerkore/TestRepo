...
{
	/// <summary>
	/// This class defines the StorePlanLowLevelTotalStoreTotalDateTotal.
	/// </summary>
	/// <remarks>
	/// The StorePlanLowLevelTotalStoreTotalDateTotal defines the values for the sum of the time periods for a variable.
	/// </remarks>

	public class StorePlanLowLevelTotalStoreTotalDateTotal : PlanPlanLowLevelTotalDateTotalCube
	{
		//=======
		// FIELDS
		//=======
		...
		/// <summary>
		/// Creates a new instance of StorePlanLowLevelTotalStoreTotalDateTotal, using the given SessionAddressBlock, Transaction, and PlanCubeGroup.
		/// </summary>
		/// <param name="aSAB">
		/// A reference to a SessionAddressBlock that this StorePlanLowLevelTotalStoreTotalDateTotal is a part of.
		/// </param>
		/// <param name="aTransaction">
		/// A reference to a Transaction that this StorePlanLowLevelTotalStoreTotalDateTotal is a part of.
		/// </param>
		/// <param name="aPlanCubeGroup">
		/// A reference to a PlanCubeGroup that this StorePlanLowLevelTotalStoreTotalDateTotal is a part of.
		/// </param>

		public StorePlanLowLevelTotalStoreTotalDateTotal(
		...
		override public string GetCellDescription(ComputationCellReference aCompCellRef)
		{
			...
			try
			{
				...
				return "Store Plan Low-Level Total Store Total Date Total" +
					", Node \"" + nodeProf.Text + "\"" +
