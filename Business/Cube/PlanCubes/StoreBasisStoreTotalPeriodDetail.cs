...
{
	/// <summary>
	/// This class defines the StoreBasisStoreTotalPeriodDetail.
	/// </summary>
	/// <remarks>
	/// The StoreBasisStoreTotalPeriodDetail defines the values for the sum of the time periods for a variable.
	/// </remarks>

	public class StoreBasisStoreTotalPeriodDetail : PlanBasisPeriodDetailCube
	{
		//=======
		// FIELDS
		//=======
		...
		/// <summary>
		/// Creates a new instance of StoreBasisStoreTotalPeriodDetail, using the given SessionAddressBlock, Transaction, and PlanCubeGroup.
		/// </summary>
		/// <param name="aSAB">
		/// A reference to a SessionAddressBlock that this StoreBasisStoreTotalPeriodDetail is a part of.
		/// </param>
		/// <param name="aTransaction">
		/// A reference to a Transaction that this StoreBasisStoreTotalPeriodDetail is a part of.
		/// </param>
		/// <param name="aPlanCubeGroup">
		/// A reference to a PlanCubeGroup that this StoreBasisStoreTotalPeriodDetail is a part of.
		/// </param>

		public StoreBasisStoreTotalPeriodDetail(
			...
			: base(aSAB, aTransaction, aPlanCubeGroup, aCubeDef, PlanCubeAttributesFlagValues.Store | CubeAttributesFlagValues.StoreTotal, aCubePriority)
		{
		}
...
//End Track #4123 - JScott - Period Comp, NonComp, and New values wrong
		...
		override public string GetCellDescription(ComputationCellReference aCompCellRef)
		{
			...
			try
			{
				...
				return "Store Basis Store Total Period Detail" +
					", Node \"" + nodeProf.Text + "\"" +
