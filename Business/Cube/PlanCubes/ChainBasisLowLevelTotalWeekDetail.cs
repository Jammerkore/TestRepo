...
{
	/// <summary>
	/// This class defines the ChainBasisLowLevelTotalWeekDetail.
	/// </summary>
	/// <remarks>
	/// The ChainBasisLowLevelTotalWeekDetail defines the values for the sum of the time periods for a variable.
	/// </remarks>

	public class ChainBasisLowLevelTotalWeekDetail : PlanBasisLowLevelTotalWeekDetailCube
	{
		//=======
		// FIELDS
		//=======
		...
		/// <summary>
		/// Creates a new instance of ChainBasisLowLevelTotalWeekDetail, using the given SessionAddressBlock, Transaction, and PlanCubeGroup.
		/// </summary>
		/// <param name="aSAB">
		/// A reference to a SessionAddressBlock that this ChainBasisLowLevelTotalWeekDetail is a part of.
		/// </param>
		/// <param name="aTransaction">
		/// A reference to a Transaction that this ChainBasisLowLevelTotalWeekDetail is a part of.
		/// </param>
		/// <param name="aPlanCubeGroup">
		/// A reference to a PlanCubeGroup that this ChainBasisLowLevelTotalWeekDetail is a part of.
		/// </param>

		public ChainBasisLowLevelTotalWeekDetail(
		...
		override public string GetCellDescription(ComputationCellReference aCompCellRef)
		{
			...
			try
			{
				weekProf = SAB.ApplicationServerSession.Calendar.GetWeek(aCompCellRef[eProfileType.Week]);
				...
				return "Chain Basis Low-Level Total Week Detail" +
