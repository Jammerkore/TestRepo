...
{
	/// <summary>
	/// This class defines the StorePlanGroupTotalPeriodDetail.
	/// </summary>
	/// <remarks>
	/// The StorePlanGroupTotalPeriodDetail defines the values for the sum of the Store Groups.
	/// </remarks>

	public class StorePlanGroupTotalPeriodDetail : PlanPlanPeriodDetailCube
	{
		//=======
		// FIELDS
		//=======
		...
		/// <summary>
		/// Creates a new instance of StorePlanGroupTotalPeriodDetail, using the given SessionAddressBlock, Transaction, and PlanCubeGroup.
		/// </summary>
		/// <param name="aSAB">
		/// A reference to a SessionAddressBlock that this StorePlanGroupTotalPeriodDetail is a part of.
		/// </param>
		/// <param name="aTransaction">
		/// A reference to a Transaction that this StorePlanGroupTotalPeriodDetail is a part of.
		/// </param>
		/// <param name="aPlanCubeGroup">
		/// A reference to a PlanCubeGroup that this StorePlanGroupTotalPeriodDetail is a part of.
		/// </param>

		public StorePlanGroupTotalPeriodDetail(
			...
			: base(aSAB, aTransaction, aPlanCubeGroup, aCubeDef, PlanCubeAttributesFlagValues.Store | CubeAttributesFlagValues.GroupTotal, aCubePriority, aReadOnly, aCheckNodeSecurity)
		{
		}
		...
		override public string GetCellDescription(ComputationCellReference aCompCellRef)
		{
			...
			try
			{
				...
				return "Store Plan Group Total Period Detail" +
					", Node \"" + nodeProf.Text + "\"" +
