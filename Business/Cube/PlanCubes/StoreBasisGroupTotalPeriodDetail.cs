...
{
	/// <summary>
	/// This class defines the StoreBasisGroupTotalPeriodDetail.
	/// </summary>
	/// <remarks>
	/// The StoreBasisGroupTotalPeriodDetail defines the values for the sum of the time periods for a variable.
	/// </remarks>

	public class StoreBasisGroupTotalPeriodDetail : PlanBasisPeriodDetailCube
	{
		//=======
		// FIELDS
		//=======
		...
		/// <summary>
		/// Creates a new instance of StoreBasisGroupTotalPeriodDetail, using the given SessionAddressBlock, Transaction, and PlanCubeGroup.
		/// </summary>
		/// <param name="aSAB">
		/// A reference to a SessionAddressBlock that this StoreBasisGroupTotalPeriodDetail is a part of.
		/// </param>
		/// <param name="aTransaction">
		/// A reference to a Transaction that this StoreBasisGroupTotalPeriodDetail is a part of.
		/// </param>
		/// <param name="aPlanCubeGroup">
		/// A reference to a PlanCubeGroup that this StoreBasisGroupTotalPeriodDetail is a part of.
		/// </param>

		public StoreBasisGroupTotalPeriodDetail(
		...
		//Begin Track #5900 - JScott - Tried to open a plan in OTS Forecast Review and received "Cube type not determined" message
		/// <summary>
		...
		//End Track #5900 - JScott - Tried to open a plan in OTS Forecast Review and received "Cube type not determined" message
		/// <summary>
		...
		override public string GetCellDescription(ComputationCellReference aCompCellRef)
		{
			...
			try
			{
				...
				return "Store Basis Group Total Period Detail" +
					", Node \"" + nodeProf.Text + "\"" +
