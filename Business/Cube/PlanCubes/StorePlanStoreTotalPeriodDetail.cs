...
{
	/// <summary>
	/// This class defines the StorePlanStoreTotalPeriodDetail.
	/// </summary>
	/// <remarks>
	/// The StorePlanStoreTotalPeriodDetail defines the values for the sum of the time periods for a variable.
	/// </remarks>

	public class StorePlanStoreTotalPeriodDetail : PlanPlanPeriodDetailCube
	{
		//=======
		// FIELDS
		//=======
		...
		/// <summary>
		/// Creates a new instance of StorePlanStoreTotalPeriodDetail, using the given SessionAddressBlock, Transaction, and PlanCubeGroup.
		/// </summary>
		/// <param name="aSAB">
		/// A reference to a SessionAddressBlock that this StorePlanStoreTotalPeriodDetail is a part of.
		/// </param>
		/// <param name="aTransaction">
		/// A reference to a Transaction that this StorePlanStoreTotalPeriodDetail is a part of.
		/// </param>
		/// <param name="aPlanCubeGroup">
		/// A reference to a PlanCubeGroup that this StorePlanStoreTotalPeriodDetail is a part of.
		/// </param>

		public StorePlanStoreTotalPeriodDetail(
			...
			: base(aSAB, aTransaction, aPlanCubeGroup, aCubeDef, PlanCubeAttributesFlagValues.Store | CubeAttributesFlagValues.StoreTotal, aCubePriority, aReadOnly, aCheckNodeSecurity)
		{
		}
		...
		override public string GetCellDescription(ComputationCellReference aCompCellRef)
		{
			...
			try
			{
				...
				return "Store Plan Store Total Period Detail" +
					", Node \"" + nodeProf.Text + "\"" +
