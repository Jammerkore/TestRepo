...
{
	/// <summary>
	/// This class defines the StoreBasisGroupTotalWeekDetail.
	/// </summary>
	/// <remarks>
	/// The StoreBasisGroupTotalWeekDetail defines the values for the sum of the time periods for a variable.
	/// </remarks>

	public class StoreBasisGroupTotalWeekDetail : PlanBasisWeekDetailCube
	{
		//=======
		// FIELDS
		//=======
		...
		/// <summary>
		/// Creates a new instance of StoreBasisGroupTotalWeekDetail, using the given SessionAddressBlock, Transaction, and PlanCubeGroup.
		/// </summary>
		/// <param name="aSAB">
		/// A reference to a SessionAddressBlock that this StoreBasisGroupTotalWeekDetail is a part of.
		/// </param>
		/// <param name="aTransaction">
		/// A reference to a Transaction that this StoreBasisGroupTotalWeekDetail is a part of.
		/// </param>
		/// <param name="aPlanCubeGroup">
		/// A reference to a PlanCubeGroup that this StoreBasisGroupTotalWeekDetail is a part of.
		/// </param>

		public StoreBasisGroupTotalWeekDetail(
		...
		override public string GetCellDescription(ComputationCellReference aCompCellRef)
		{
			...
			try
			{
				...
				return "Store Basis Group Total Week Detail" +
					", Node \"" + nodeProf.Text + "\"" +
