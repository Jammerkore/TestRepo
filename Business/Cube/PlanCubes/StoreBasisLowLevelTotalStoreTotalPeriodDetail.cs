...
{
	/// <summary>
	/// This class defines the StoreBasisLowLevelTotalStoreTotalPeriodDetail.
	/// </summary>
	/// <remarks>
	/// The StoreBasisLowLevelTotalStoreTotalPeriodDetail defines the values for the sum of the time periods for a variable.
	/// </remarks>

	public class StoreBasisLowLevelTotalStoreTotalPeriodDetail : PlanBasisLowLevelTotalPeriodDetailCube
	{
		//=======
		// FIELDS
		//=======
		...
		/// <summary>
		/// Creates a new instance of StoreBasisLowLevelTotalStoreTotalPeriodDetail, using the given SessionAddressBlock, Transaction, and PlanCubeGroup.
		/// </summary>
		/// <param name="aSAB">
		/// A reference to a SessionAddressBlock that this StoreBasisLowLevelTotalStoreTotalPeriodDetail is a part of.
		/// </param>
		/// <param name="aTransaction">
		/// A reference to a Transaction that this StoreBasisLowLevelTotalStoreTotalPeriodDetail is a part of.
		/// </param>
		/// <param name="aPlanCubeGroup">
		/// A reference to a PlanCubeGroup that this StoreBasisLowLevelTotalStoreTotalPeriodDetail is a part of.
		/// </param>

		public StoreBasisLowLevelTotalStoreTotalPeriodDetail(
			...
			: base(aSAB, aTransaction, aPlanCubeGroup, aCubeDef, PlanCubeAttributesFlagValues.Store | PlanCubeAttributesFlagValues.LowLevelTotal | CubeAttributesFlagValues.StoreTotal, aCubePriority)
		{
		}
		...
		override public string GetCellDescription(ComputationCellReference aCompCellRef)
		{
			...
			try
			{
				...
				return "Store Basis Low-Level Total Store Total Period Detail" +
