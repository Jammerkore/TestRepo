...
{
	/// <summary>
	/// This class defines the ChainBasisPeriodDetail.
	/// </summary>
	/// <remarks>
	/// The ChainBasisPeriodDetail defines the values for the sum of the time periods for a variable.
	/// </remarks>

	public class ChainBasisPeriodDetail : PlanBasisPeriodDetailCube
	{
		//=======
		// FIELDS
		//=======
		...
		/// <summary>
		/// Creates a new instance of ChainBasisPeriodDetail, using the given SessionAddressBlock, Transaction, and PlanCubeGroup.
		/// </summary>
		/// <param name="aSAB">
		/// A reference to a SessionAddressBlock that this ChainBasisPeriodDetail is a part of.
		/// </param>
		/// <param name="aTransaction">
		/// A reference to a Transaction that this ChainBasisPeriodDetail is a part of.
		/// </param>
		/// <param name="aPlanCubeGroup">
		/// A reference to a PlanCubeGroup that this ChainBasisPeriodDetail is a part of.
		/// </param>

		public ChainBasisPeriodDetail(
...
//End Track #4123 - JScott - Period Comp, NonComp, and New values wrong
		...
		override public string GetCellDescription(ComputationCellReference aCompCellRef)
		{
			...
			try
			{
				...
				return "Chain Basis Period Detail" +
					", Node \"" + nodeProf.Text + "\"" +
