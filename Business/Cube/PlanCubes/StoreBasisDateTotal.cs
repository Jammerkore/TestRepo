...
{
	/// <summary>
	/// This class defines the StoreBasisDateTotal.
	/// </summary>
	/// <remarks>
	/// The StoreBasisDateTotal defines the values for the sum of the time periods for a variable.
	/// </remarks>

	public class StoreBasisDateTotal : PlanBasisDateTotalCube
	{
		//=======
		// FIELDS
		//=======
		...
		/// <summary>
		/// Creates a new instance of StoreBasisDateTotal, using the given SessionAddressBlock, Transaction, and PlanCubeGroup.
		/// </summary>
		/// <param name="aSAB">
		/// A reference to a SessionAddressBlock that this StoreBasisDateTotal is a part of.
		/// </param>
		/// <param name="aTransaction">
		/// A reference to a Transaction that this StoreBasisDateTotal is a part of.
		/// </param>
		/// <param name="aPlanCubeGroup">
		/// A reference to a PlanCubeGroup that this StoreBasisDateTotal is a part of.
		/// </param>

		public StoreBasisDateTotal(
