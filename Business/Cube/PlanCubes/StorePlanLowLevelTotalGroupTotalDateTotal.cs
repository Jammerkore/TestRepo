...
{
	/// <summary>
	/// This class defines the StorePlanLowLevelTotalGroupTotalDateTotal.
	/// </summary>
	/// <remarks>
	/// The StorePlanLowLevelTotalGroupTotalDateTotal defines the values for the sum of the time periods for a variable.
	/// </remarks>

	public class StorePlanLowLevelTotalGroupTotalDateTotal : PlanPlanLowLevelTotalDateTotalCube
	{
		//=======
		// FIELDS
		//=======
		...
		/// <summary>
		/// Creates a new instance of StorePlanLowLevelTotalGroupTotalDateTotal, using the given SessionAddressBlock, Transaction, and PlanCubeGroup.
		/// </summary>
		/// <param name="aSAB">
		/// A reference to a SessionAddressBlock that this StorePlanLowLevelTotalGroupTotalDateTotal is a part of.
		/// </param>
		/// <param name="aTransaction">
		/// A reference to a Transaction that this StorePlanLowLevelTotalGroupTotalDateTotal is a part of.
		/// </param>
		/// <param name="aPlanCubeGroup">
		/// A reference to a PlanCubeGroup that this StorePlanLowLevelTotalGroupTotalDateTotal is a part of.
		/// </param>

		public StorePlanLowLevelTotalGroupTotalDateTotal(
		...
		override public string GetCellDescription(ComputationCellReference aCompCellRef)
		{
			...
			try
			{
				...
				return "Store Plan Low-Level Total Group Total Date Total" +
					", Node \"" + nodeProf.Text + "\"" +
