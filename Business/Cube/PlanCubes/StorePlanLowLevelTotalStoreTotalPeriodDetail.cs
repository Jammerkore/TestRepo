...
{
	/// <summary>
	/// This class defines the StorePlanLowLevelTotalStoreTotalPeriodDetail.
	/// </summary>
	/// <remarks>
	/// The StorePlanLowLevelTotalStoreTotalPeriodDetail defines the values for the sum of the time periods for a variable.
	/// </remarks>

	public class StorePlanLowLevelTotalStoreTotalPeriodDetail : PlanPlanLowLevelTotalPeriodDetailCube
	{
		//=======
		// FIELDS
		//=======
		...
		/// <summary>
		/// Creates a new instance of StorePlanLowLevelTotalStoreTotalPeriodDetail, using the given SessionAddressBlock, Transaction, and PlanCubeGroup.
		/// </summary>
		/// <param name="aSAB">
		/// A reference to a SessionAddressBlock that this StorePlanLowLevelTotalStoreTotalPeriodDetail is a part of.
		/// </param>
		/// <param name="aTransaction">
		/// A reference to a Transaction that this StorePlanLowLevelTotalStoreTotalPeriodDetail is a part of.
		/// </param>
		/// <param name="aPlanCubeGroup">
		/// A reference to a PlanCubeGroup that this StorePlanLowLevelTotalStoreTotalPeriodDetail is a part of.
		/// </param>

		public StorePlanLowLevelTotalStoreTotalPeriodDetail(
			...
			: base(aSAB, aTransaction, aPlanCubeGroup, aCubeDef, PlanCubeAttributesFlagValues.Store | PlanCubeAttributesFlagValues.LowLevelTotal | CubeAttributesFlagValues.StoreTotal, aCubePriority, aReadOnly, false)
		{
		}
		...
		override public string GetCellDescription(ComputationCellReference aCompCellRef)
		{
			...
			try
			{
				...
				return "Store Plan Low-Level Total Store Total Period Detail" +
					", Node \"" + nodeProf.Text + "\"" +
