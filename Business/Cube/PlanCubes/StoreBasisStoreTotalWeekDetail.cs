...
{
	/// <summary>
	/// This class defines the StoreBasisStoreTotalWeekDetail.
	/// </summary>
	/// <remarks>
	/// The StoreBasisStoreTotalWeekDetail defines the values for the sum of the time periods for a variable.
	/// </remarks>

	public class StoreBasisStoreTotalWeekDetail : PlanBasisWeekDetailCube
	{
		//=======
		// FIELDS
		//=======
		...
		/// <summary>
		/// Creates a new instance of StoreBasisStoreTotalWeekDetail, using the given SessionAddressBlock, Transaction, and PlanCubeGroup.
		/// </summary>
		/// <param name="aSAB">
		/// A reference to a SessionAddressBlock that this StoreBasisStoreTotalWeekDetail is a part of.
		/// </param>
		/// <param name="aTransaction">
		/// A reference to a Transaction that this StoreBasisStoreTotalWeekDetail is a part of.
		/// </param>
		/// <param name="aPlanCubeGroup">
		/// A reference to a PlanCubeGroup that this StoreBasisStoreTotalWeekDetail is a part of.
		/// </param>

		public StoreBasisStoreTotalWeekDetail(
		...
		override public string GetCellDescription(ComputationCellReference aCompCellRef)
		{
			...
			try
			{
				...
				return "Store Basis Store Total Week Detail" +
					", Node \"" + nodeProf.Text + "\"" +
