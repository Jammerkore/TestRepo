...
{
	/// <summary>
	/// This class defines the PlanBasisDateTotalCube.
	/// </summary>
	/// <remarks>
	/// The PlanBasisDateTotalCube defines a cube that contains the date totals of the basis values.
	/// </remarks>

	abstract public class PlanBasisDateTotalCube : PlanBasisCube
	{
		//=======
		// FIELDS
		//=======
		...
		/// <summary>
		/// Creates a new instance of PlanBasisDateTotalCube, using the given SessionAddressBlock, Transaction, and PlanCubeGroup.
		/// </summary>
		/// <param name="aSAB">
		/// A reference to a SessionAddressBlock that this PlanBasisDateTotalCube is a part of.
		/// </param>
		/// <param name="aTransaction">
		/// A reference to a Transaction that this PlanBasisDateTotalCube is a part of.
		/// </param>
		/// <param name="aPlanCubeGroup">
		/// A reference to a PlanCubeGroup that this PlanBasisDateTotalCube is a part of.
		/// </param>

		public PlanBasisDateTotalCube(
			...
			: base(aSAB, aTransaction, aPlanCubeGroup, aCubeDef, (ushort)(aCubeAttributes | PlanCubeAttributesFlagValues.DateTotal), aCubePriority)
		{
		}
