...
{
	/// <summary>
	/// This class defines the StorePlanLowLevelTotalStoreTotalWeekDetail.
	/// </summary>
	/// <remarks>
	/// The StorePlanLowLevelTotalStoreTotalWeekDetail defines the values for the sum of the time periods for a variable.
	/// </remarks>

	public class StorePlanLowLevelTotalStoreTotalWeekDetail : PlanPlanLowLevelTotalWeekDetailCube
	{
		//=======
		// FIELDS
		//=======
		...
		/// <summary>
		/// Creates a new instance of StorePlanLowLevelTotalStoreTotalWeekDetail, using the given SessionAddressBlock, Transaction, and PlanCubeGroup.
		/// </summary>
		/// <param name="aSAB">
		/// A reference to a SessionAddressBlock that this StorePlanLowLevelTotalStoreTotalWeekDetail is a part of.
		/// </param>
		/// <param name="aTransaction">
		/// A reference to a Transaction that this StorePlanLowLevelTotalStoreTotalWeekDetail is a part of.
		/// </param>
		/// <param name="aPlanCubeGroup">
		/// A reference to a PlanCubeGroup that this StorePlanLowLevelTotalStoreTotalWeekDetail is a part of.
		/// </param>

		public StorePlanLowLevelTotalStoreTotalWeekDetail(
		...
		override public string GetCellDescription(ComputationCellReference aCompCellRef)
		{
			...
			try
			{
				...
				return "Store Plan Low-Level Total Store Total Week Detail" +
					", Node \"" + nodeProf.Text + "\"" +
