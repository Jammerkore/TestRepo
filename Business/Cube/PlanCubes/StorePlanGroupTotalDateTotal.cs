...
{
	/// <summary>
	/// This class defines the StorePlanGroupTotalDateTotal.
	/// </summary>
	/// <remarks>
	/// The StorePlanGroupTotalDateTotal defines the values for the sum of the time periods for a variable.
	/// </remarks>

	public class StorePlanGroupTotalDateTotal : PlanPlanDateTotalCube
	{
		//=======
		// FIELDS
		//=======
		...
		/// <summary>
		/// Creates a new instance of StorePlanGroupTotalDateTotal, using the given SessionAddressBlock, Transaction, and PlanCubeGroup.
		/// </summary>
		/// <param name="aSAB">
		/// A reference to a SessionAddressBlock that this StorePlanGroupTotalDateTotal is a part of.
		/// </param>
		/// <param name="aTransaction">
		/// A reference to a Transaction that this StorePlanGroupTotalDateTotal is a part of.
		/// </param>
		/// <param name="aPlanCubeGroup">
		/// A reference to a PlanCubeGroup that this StorePlanGroupTotalDateTotal is a part of.
		/// </param>

		public StorePlanGroupTotalDateTotal(
		...
		override public string GetCellDescription(ComputationCellReference aCompCellRef)
		{
			...
			try
			{
				...
				return "Store Plan Group Total Date Total" +
					", Node \"" + nodeProf.Text + "\"" +
