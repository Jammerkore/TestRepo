...
{
	/// <summary>
	/// This class defines the ChainPlanLowLevelTotalPeriodDetail.
	/// </summary>
	/// <remarks>
	/// The ChainPlanLowLevelTotalPeriodDetail defines the values for the sum of the time periods for a variable.
	/// </remarks>

	public class ChainPlanLowLevelTotalPeriodDetail : PlanPlanLowLevelTotalPeriodDetailCube
	{
		//=======
		// FIELDS
		//=======
		...
		/// <summary>
		/// Creates a new instance of ChainPlanLowLevelTotalPeriodDetail, using the given SessionAddressBlock, Transaction, and PlanCubeGroup.
		/// </summary>
		/// <param name="aSAB">
		/// A reference to a SessionAddressBlock that this ChainPlanLowLevelTotalPeriodDetail is a part of.
		/// </param>
		/// <param name="aTransaction">
		/// A reference to a Transaction that this ChainPlanLowLevelTotalPeriodDetail is a part of.
		/// </param>
		/// <param name="aPlanCubeGroup">
		/// A reference to a PlanCubeGroup that this ChainPlanLowLevelTotalPeriodDetail is a part of.
		/// </param>

		public ChainPlanLowLevelTotalPeriodDetail(
		...
		override public string GetCellDescription(ComputationCellReference aCompCellRef)
		{
			...
			try
			{
				...
				return "Chain Plan Low-Level Total Period Detail" +
					", Period \"" + perProf.Name + "\"" +
