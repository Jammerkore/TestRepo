...
{
	/// <summary>
	/// This class defines the PlanBasisLowLevelTotalDateTotal.
	/// </summary>
	/// <remarks>
	/// The PlanBasisLowLevelTotalDateTotal defines the values for the sum of the time periods for a variable.
	/// </remarks>

	abstract public class PlanBasisLowLevelTotalDateTotalCube : PlanBasisDateTotalCube
	{
		//=======
		// FIELDS
		//=======
		...
		/// <summary>
		/// Creates a new instance of PlanBasisLowLevelTotalDateTotal, using the given SessionAddressBlock, Transaction, and PlanCubeGroup.
		/// </summary>
		/// <param name="aSAB">
		/// A reference to a SessionAddressBlock that this PlanBasisLowLevelTotalDateTotal is a part of.
		/// </param>
		/// <param name="aTransaction">
		/// A reference to a Transaction that this PlanBasisLowLevelTotalDateTotal is a part of.
		/// </param>
		/// <param name="aPlanCubeGroup">
		/// A reference to a PlanCubeGroup that this PlanBasisLowLevelTotalDateTotal is a part of.
		/// </param>

		public PlanBasisLowLevelTotalDateTotalCube(
