...
{
	/// <summary>
	/// This class defines the ChainPlanDateTotal.
	/// </summary>
	/// <remarks>
	/// The ChainPlanDateTotal defines the values for the sum of the time periods for a variable.
	/// </remarks>

	public class ChainPlanDateTotal : PlanPlanDateTotalCube
	{
		//=======
		// FIELDS
		//=======
		...
		/// <summary>
		/// Creates a new instance of ChainPlanDateTotal, using the given SessionAddressBlock, Transaction, and PlanCubeGroup.
		/// </summary>
		/// <param name="aSAB">
		/// A reference to a SessionAddressBlock that this ChainPlanDateTotal is a part of.
		/// </param>
		/// <param name="aTransaction">
		/// A reference to a Transaction that this ChainPlanDateTotal is a part of.
		/// </param>
		/// <param name="aPlanCubeGroup">
		/// A reference to a PlanCubeGroup that this ChainPlanDateTotal is a part of.
		/// </param>

		public ChainPlanDateTotal(
        ...
        public void ExtractCube(ExtractOptions aExtractOptions)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    foreach (TimeTotalVariableProfile varProf in PlanCubeGroup.TotalVariables.GetChainTimeTotalVariableList())
                    {
                    ...
                    if (valueCol.Count > 0
                        || stringCol.Count > 0)
                    {
                        PlanCubeGroup.ROExtractData.Planning_Chain_Total_Insert(
                        ...
                        {
                            PlanCubeGroup.ROExtractData.Planning_Chain_Total_Update();
