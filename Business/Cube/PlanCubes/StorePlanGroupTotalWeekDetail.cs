...
{
	/// <summary>
	/// This class defines the StorePlanGroupTotalWeekDetail.
	/// </summary>
	/// <remarks>
	/// The StorePlanGroupTotalWeekDetail defines the values for the sum of the Store Groups.
	/// </remarks>

	public class StorePlanGroupTotalWeekDetail : PlanPlanWeekDetailCube
	{
		//=======
		// FIELDS
		//=======
		...
		/// <summary>
		/// Creates a new instance of StorePlanGroupTotalWeekDetail, using the given SessionAddressBlock, Transaction, and PlanCubeGroup.
		/// </summary>
		/// <param name="aSAB">
		/// A reference to a SessionAddressBlock that this StorePlanGroupTotalWeekDetail is a part of.
		/// </param>
		/// <param name="aTransaction">
		/// A reference to a Transaction that this StorePlanGroupTotalWeekDetail is a part of.
		/// </param>
		/// <param name="aPlanCubeGroup">
		/// A reference to a PlanCubeGroup that this StorePlanGroupTotalWeekDetail is a part of.
		/// </param>

		public StorePlanGroupTotalWeekDetail(
		...
		override public string GetCellDescription(ComputationCellReference aCompCellRef)
		{
			...
			try
			{
				...
				return "Store Plan Group Total Week Detail" +
					", Node \"" + nodeProf.Text + "\"" +
