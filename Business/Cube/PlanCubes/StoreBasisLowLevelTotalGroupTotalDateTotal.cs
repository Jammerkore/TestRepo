...
{
	/// <summary>
	/// This class defines the StoreBasisLowLevelTotalGroupTotalDateTotal.
	/// </summary>
	/// <remarks>
	/// The StoreBasisLowLevelTotalGroupTotalDateTotal defines the values for the sum of the time periods for a variable.
	/// </remarks>

	public class StoreBasisLowLevelTotalGroupTotalDateTotal : PlanBasisLowLevelTotalDateTotalCube
	{
		//=======
		// FIELDS
		//=======
		...
		/// <summary>
		/// Creates a new instance of StoreBasisLowLevelTotalGroupTotalDateTotal, using the given SessionAddressBlock, Transaction, and PlanCubeGroup.
		/// </summary>
		/// <param name="aSAB">
		/// A reference to a SessionAddressBlock that this StoreBasisLowLevelTotalGroupTotalDateTotal is a part of.
		/// </param>
		/// <param name="aTransaction">
		/// A reference to a Transaction that this StoreBasisLowLevelTotalGroupTotalDateTotal is a part of.
		/// </param>
		/// <param name="aPlanCubeGroup">
		/// A reference to a PlanCubeGroup that this StoreBasisLowLevelTotalGroupTotalDateTotal is a part of.
		/// </param>

		public StoreBasisLowLevelTotalGroupTotalDateTotal(
		...
		override public string GetCellDescription(ComputationCellReference aCompCellRef)
		{
			...
			try
			{
				...
				return "Store Basis Low-Level Total Group Total Date Total" +
