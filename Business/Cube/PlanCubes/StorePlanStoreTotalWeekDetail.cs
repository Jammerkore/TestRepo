...
{
	/// <summary>
	/// This class defines the StorePlanStoreTotalWeekDetail.
	/// </summary>
	/// <remarks>
	/// The StorePlanStoreTotalWeekDetail defines the values for the sum of the time periods for a variable.
	/// </remarks>

	public class StorePlanStoreTotalWeekDetail : PlanPlanWeekDetailCube
	{
		//=======
		// FIELDS
		//=======
		...
		/// <summary>
		/// Creates a new instance of StorePlanStoreTotalWeekDetail, using the given SessionAddressBlock, Transaction, and PlanCubeGroup.
		/// </summary>
		/// <param name="aSAB">
		/// A reference to a SessionAddressBlock that this StorePlanStoreTotalWeekDetail is a part of.
		/// </param>
		/// <param name="aTransaction">
		/// A reference to a Transaction that this StorePlanStoreTotalWeekDetail is a part of.
		/// </param>
		/// <param name="aPlanCubeGroup">
		/// A reference to a PlanCubeGroup that this StorePlanStoreTotalWeekDetail is a part of.
		/// </param>

		public StorePlanStoreTotalWeekDetail(
		...
		override public string GetCellDescription(ComputationCellReference aCompCellRef)
		{
			...
			try
			{
				...
				return "Store Plan Store Total Week Detail" +
					", Node \"" + nodeProf.Text + "\"" +
