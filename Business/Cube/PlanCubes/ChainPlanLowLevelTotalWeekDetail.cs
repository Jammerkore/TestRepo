...
{
	/// <summary>
	/// This class defines the ChainPlanLowLevelTotalWeekDetail.
	/// </summary>
	/// <remarks>
	/// The ChainPlanLowLevelTotalWeekDetail defines the values for the sum of the time periods for a variable.
	/// </remarks>

	public class ChainPlanLowLevelTotalWeekDetail : PlanPlanLowLevelTotalWeekDetailCube
	{
		//=======
		// FIELDS
		//=======
		...
		/// <summary>
		/// Creates a new instance of ChainPlanLowLevelTotalWeekDetail, using the given SessionAddressBlock, Transaction, and PlanCubeGroup.
		/// </summary>
		/// <param name="aSAB">
		/// A reference to a SessionAddressBlock that this ChainPlanLowLevelTotalWeekDetail is a part of.
		/// </param>
		/// <param name="aTransaction">
		/// A reference to a Transaction that this ChainPlanLowLevelTotalWeekDetail is a part of.
		/// </param>
		/// <param name="aPlanCubeGroup">
		/// A reference to a PlanCubeGroup that this ChainPlanLowLevelTotalWeekDetail is a part of.
		/// </param>

		public ChainPlanLowLevelTotalWeekDetail(
		...
		override public string GetCellDescription(ComputationCellReference aCompCellRef)
		{
			...
			try
			{
				...
				return "Chain Plan Low-Level Total Week Detail" +
					", Week \"" + weekProf.Text() + "\"" +
