...
{
	/// <summary>
	/// This class defines the StoreBasisLowLevelTotalStoreTotalDateTotal.
	/// </summary>
	/// <remarks>
	/// The StoreBasisLowLevelTotalStoreTotalDateTotal defines the values for the sum of the time periods for a variable.
	/// </remarks>

	public class StoreBasisLowLevelTotalStoreTotalDateTotal : PlanBasisLowLevelTotalDateTotalCube
	{
		//=======
		// FIELDS
		//=======
		...
		/// <summary>
		/// Creates a new instance of StoreBasisLowLevelTotalStoreTotalDateTotal, using the given SessionAddressBlock, Transaction, and PlanCubeGroup.
		/// </summary>
		/// <param name="aSAB">
		/// A reference to a SessionAddressBlock that this StoreBasisLowLevelTotalStoreTotalDateTotal is a part of.
		/// </param>
		/// <param name="aTransaction">
		/// A reference to a Transaction that this StoreBasisLowLevelTotalStoreTotalDateTotal is a part of.
		/// </param>
		/// <param name="aPlanCubeGroup">
		/// A reference to a PlanCubeGroup that this StoreBasisLowLevelTotalStoreTotalDateTotal is a part of.
		/// </param>

		public StoreBasisLowLevelTotalStoreTotalDateTotal(
		...
		override public string GetCellDescription(ComputationCellReference aCompCellRef)
		{
			...
			try
			{
				...
				return "Store Basis Low-Level Total Store Total Date Total" +
