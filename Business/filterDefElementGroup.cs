...
namespace MIDRetail.Business
{
    ...
    public sealed class elementUITypes
    {
        public static List<elementUITypes> typeList = new List<elementUITypes>();
        public static readonly elementUITypes Calendar = new elementUITypes(0);
        public static readonly elementUITypes Field = new elementUITypes(1);
        public static readonly elementUITypes Folder = new elementUITypes(2);
        public static readonly elementUITypes Info = new elementUITypes(3);
        public static readonly elementUITypes Limit = new elementUITypes(4);
        public static readonly elementUITypes List = new elementUITypes(5);
        public static readonly elementUITypes Logic = new elementUITypes(6);
        public static readonly elementUITypes Merchandise = new elementUITypes(7);
        public static readonly elementUITypes Name = new elementUITypes(8);
        public static readonly elementUITypes OperatorDate = new elementUITypes(9);
        public static readonly elementUITypes OperatorIn = new elementUITypes(10);
        public static readonly elementUITypes OperatorNumeric = new elementUITypes(11);
        public static readonly elementUITypes OperatorNumericForVariables = new elementUITypes(12);
        public static readonly elementUITypes OperatorString = new elementUITypes(13);
        public static readonly elementUITypes OperatorVariablePercentage = new elementUITypes(14);
        public static readonly elementUITypes SortBy = new elementUITypes(15);
        public static readonly elementUITypes SortByDirection = new elementUITypes(16);
        public static readonly elementUITypes SortByType = new elementUITypes(17);
        public static readonly elementUITypes ValueToCompareBool = new elementUITypes(18);
        public static readonly elementUITypes ValueToCompareDateBetween = new elementUITypes(19);
        public static readonly elementUITypes ValueToCompareDateSpecify = new elementUITypes(20);
        public static readonly elementUITypes ValueToCompareNumeric = new elementUITypes(21);
        public static readonly elementUITypes ValueToCompareNumericBetween = new elementUITypes(22);
        public static readonly elementUITypes ValueToCompareString = new elementUITypes(23);   
        public static readonly elementUITypes Variable = new elementUITypes(24);

        private elementUITypes(int Index)
        {
            this.Index = Index;
            typeList.Add(this);
        }
        ...
        public static implicit operator int(elementUITypes op) { return op.Index; }


        public static elementUITypes FromIndex(int Index)
        {
            elementUITypes result = typeList.Find(
               delegate(elementUITypes ft)
               {
    ...
    public class elementBase
    {
        ...
        public elementUITypes elementUIType;
        ...
        public elementBase(filterManager manager, elementUITypes elementUIType, string groupHeading, bool isList = false)
        {
    ...
    public sealed class elementGroupTypes
    {
        ...
        public static readonly elementGroupTypes StoreAttributeSet = new elementGroupTypes("Attribute Set", 22, typeof(elementGroupStoreAttributeSet), navigationTypes.Condition, costToRunEstimate: 100);
    ...
    public class elementGroupName : elementGroup
    {
        public elementGroupName(filterManager manager)
        {
            ...
            base.elementList.Add(new elementBase(manager, elementUITypes.Name, base.groupSettings.groupTitle));
        }
    ...
    public class elementGroupFolder : elementGroup
    {
        ...
        public elementGroupFolder(filterManager manager)
        {
            ...
            base.elementList.Add(new elementBase(manager, elementUITypes.Folder, base.groupSettings.groupTitle));
        }
        public override void BuildFormattedText(optionDefinition options, ref filterCondition fc)
        {
            string formattedText = string.Empty;
    ...
    public class elementGroupLimit : elementGroup
    {
        public elementGroupLimit(filterManager manager)
        {
            ...
            base.elementList.Add(new elementBase(manager, elementUITypes.Limit, base.groupSettings.groupTitle));
        }
        public override void BuildFormattedText(optionDefinition options, ref filterCondition fc)
        {
            string formattedText = string.Empty;
    ...
    public class elementGroupInfoFilter : elementGroup
    {
        public elementGroupInfoFilter(filterManager manager)
        {
            ...
            base.elementList.Add(new elementBase(manager, elementUITypes.Info, "Filter Information"));
        }
        public override void BuildFormattedText(optionDefinition options, ref filterCondition fc)
        {
            string formattedText = string.Empty;
    ...
    public class elementGroupInfoConditions : elementGroup
    {
        public elementGroupInfoConditions(filterManager manager)
        {
            ...
            base.elementList.Add(new elementBase(manager, elementUITypes.Info, "Conditions"));
        }
        public override void BuildFormattedText(optionDefinition options, ref filterCondition fc)
        {
            string formattedText = string.Empty;
    ...
    public class elementGroupInfoSortBy : elementGroup
    {
        public elementGroupInfoSortBy(filterManager manager)
        {
            ...
            base.elementList.Add(new elementBase(manager, elementUITypes.Info, "Sort By"));
        }
        public override void BuildFormattedText(optionDefinition options, ref filterCondition fc)
        {
            string formattedText = string.Empty;
    ...
    public class elementGroupStoreStatus : elementGroup
    {
        public elementGroupStoreStatus(filterManager manager)
        {
            ...
            base.elementList.Add(new elementBase(manager, elementUITypes.Logic, "And / Or"));
            base.elementList.Add(new elementBase(manager, elementUITypes.OperatorIn, "In / Not In"));
            base.elementList.Add(new elementBase(manager, elementUITypes.List, base.groupSettings.groupTitle, true));
    ...
    public class elementGroupStoreFields : elementGroup
    {
        public elementGroupStoreFields(filterManager manager)
        {
            ...
            base.elementList.Add(new elementBase(manager, elementUITypes.Logic, "And / Or"));
            elementBase eb = new elementBase(manager, elementUITypes.Field, "Store Field:");
            eb.isField = true;
    ...
    //public class elementGroupStoreAttributeSet : elementGroup
    //{
    //    public elementGroupStoreAttributeSet(filterManager manager)
    //    {
    ...
    //        base.elementList.Add(new elementBase(manager, elementUITypes.Logic, "And / Or"));
    //        elementBase eb = new elementBase(manager, elementUITypes.AttributeSet, "Attribute Set");
    //        base.elementList.Add(eb);
    //    }
    //    public override void BuildFormattedText(optionDefinition options, ref filterCondition fc)
    //    {
    //        string formattedText = string.Empty;
    //        formattedText += filterUtility.FormatLogic(options, logicTypes.FromIndex(fc.logicIndex).Name);
    //        formattedText += filterUtility.FormatNormal(options, " Stores In");
    //        formattedText += filterUtility.FormatValue(options, " " + fc.valueToCompare);
    ...
    public class elementGroupStoreAttributeSet : elementGroup
    {
        ...
        {
            base.groupSettings.groupTitle = "Attribute Set";
            base.groupSettings.valueSettings.loadFieldList = new LoadListDelegate(filterDataHelper.AttributeSetGetDataTable);
            base.groupSettings.valueSettings.GetValueInfoTypeFromFieldIndex = new GetValueInfoTypeFromFieldIndexDelegate(filterDataHelper.AttributeSetGetValueInfoType);
            base.groupSettings.valueSettings.GetNameFromField = new GetNameFromFieldIndexDelegate(filterDataHelper.AttributeSetGetNameFromIndex);
            base.groupSettings.valueSettings.fieldForData = "FIELD_INDEX";
            base.groupSettings.valueSettings.fieldForDisplay = "FIELD_NAME";

            base.groupSettings.valueSettings.loadValueListFromField = new LoadValueListFromFieldDelegate(filterDataHelper.AttributeSetGetValuesForGroup);
            base.groupSettings.valueSettings.valueFieldForData = "GROUP_INDEX";
            base.groupSettings.valueSettings.valueFieldForDisplay = "GROUP_NAME";
            base.groupSettings.valueSettings.listValueType = listValueTypes.StoreGroupLevel;

            base.elementList.Add(new elementBase(manager, elementUITypes.Logic, "And / Or"));
            string attributeSet = MIDRetail.Data.MIDText.GetTextFromCode((int)eMIDTextCode.lbl_AttributeSet) + ":";
            elementBase eb = new elementBase(manager, elementUITypes.Field, attributeSet);
            eb.isField = true;
        ...
        public override void BuildFormattedText(optionDefinition options, ref filterCondition fc)
        {
            ...
            //{
                formattedText += filterUtility.FormatOperator(options, " " + listOperatorTypes.FromIndex(fc.operatorIndex).symbol);
                formattedText += filterUtility.FormatValue(options, " (");
                formattedText += filterUtility.FormatValue(options, filterUtility.GetDisplayList(fc.listConstantType, fc.GetListValues(listValueTypes.StoreGroupLevel), base.groupSettings.valueSettings.loadValueListFromField(fc.fieldIndex), base.groupSettings.valueSettings.valueFieldForData, "GROUP_NAME_NO_COUNT"));
                formattedText += filterUtility.FormatValue(options, ")");
            //}
            //else if (vt == valueTypes.Text)
            //{
    ...
    public class elementGroupHeaderFields : elementGroup
    {
        public elementGroupHeaderFields(filterManager manager)
        {
            ...
            base.elementList.Add(new elementBase(manager, elementUITypes.Logic, "And / Or"));
            elementBase eb = new elementBase(manager, elementUITypes.Field, "Header Field:");
            eb.isField = true;
            base.elementList.Add(eb);
        }
        public override void BuildFormattedText(optionDefinition options, ref filterCondition fc)
    ...
    public class elementGroupStoreCharacteristics : elementGroup
    {
        public elementGroupStoreCharacteristics(filterManager manager)
        {
            ...
            base.elementList.Add(new elementBase(manager, elementUITypes.Logic, "And / Or"));
            elementBase eb = new elementBase(manager, elementUITypes.Field, "Characteristics:");
            eb.isField = true;
            base.elementList.Add(eb);
        }
        public override void BuildFormattedText(optionDefinition options, ref filterCondition fc)
    ...
    public class elementGroupHeaderMerchandise : elementGroup
    {
        public elementGroupHeaderMerchandise(filterManager manager)
        {
            ...
            base.elementList.Add(new elementBase(manager, elementUITypes.Logic, "And / Or"));
            elementBase b1 = new elementBase(manager, elementUITypes.Merchandise, "Merchandise");
    ...
    public class elementGroupStoreVariablePercentage : elementGroup
    {
        public elementGroupStoreVariablePercentage(filterManager manager)
        {
            ...
            elementBase b1 = new elementBase(manager, elementUITypes.Variable, "1st Variable:");
            b1.loadFromVariable1 = true;
            b1.loadFromVariable2 = false;
            base.elementList.Add(b1);

            elementBase bPercentOp = new elementBase(manager, elementUITypes.OperatorVariablePercentage, "Percent Operator");
            ...
            elementBase b2 = new elementBase(manager, elementUITypes.Variable, "2nd Variable:");
            b2.loadFromVariable1 = false;
            b2.loadFromVariable2 = true;
            base.elementList.Add(b2);

            elementBase bOp = new elementBase(manager, elementUITypes.OperatorNumeric, "Operator");
    ...
    public class elementGroupStoreVariableToConstant : elementGroup
    {
        public elementGroupStoreVariableToConstant(filterManager manager)
        {
            ...
            elementBase b1 = new elementBase(manager, elementUITypes.Variable, "Variable:");
            b1.isVariable = true;
            b1.loadFromVariable1 = true;
            b1.loadFromVariable2 = false;
        ...
        public override void BuildFormattedText(optionDefinition options, ref filterCondition fc)
        {
            ...
            if (fc.valueTypeIndex == valueTypes.Text)
            {
                BuildFormattedTextForString(ref formattedText, options, fc);
            }
            else
    ...
    public class elementGroupStoreVariableToVariable : elementGroup
    {
        public elementGroupStoreVariableToVariable(filterManager manager)
        {
            ...
            elementBase bOp = new elementBase(manager, elementUITypes.OperatorNumericForVariables, "Operator");
            base.elementList.Add(bOp);
    ...
    public class elementGroupHeaderDate : elementGroup
    {
        public elementGroupHeaderDate(filterManager manager)
        {
            ...
            base.elementList.Add(new elementBase(manager, elementUITypes.Logic, "And / Or"));
            elementBase eb = new elementBase(manager, elementUITypes.OperatorDate, "Header Date:");
    ...
    public class elementGroupHeaderReleaseDate : elementGroup
    {
        public elementGroupHeaderReleaseDate(filterManager manager)
        {
            ...
            base.elementList.Add(new elementBase(manager, elementUITypes.Logic, "And / Or"));
            elementBase eb = new elementBase(manager, elementUITypes.OperatorDate, "Rls Date:");
            eb.isOperatorDate = true;
            valueInfoTypes vInfo = new valueInfoTypes(valueTypes.Date);
    ...
    public class elementGroupStoreSortBy : elementGroup
    {
        public elementGroupStoreSortBy(filterManager manager)
        {
            ...
            elementBase eb = new elementBase(manager, elementUITypes.SortByType, "Sort By Type");
            eb.isSortBy = true;
            base.elementList.Add(eb);
