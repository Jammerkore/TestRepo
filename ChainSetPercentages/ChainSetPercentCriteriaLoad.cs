...
{
    /// <summary>
    /// Summary description for ChainSetPercentCriteriaLoad.
    /// </summary>
    class ChainSetPercentCriteriaLoad
    {
        /// <summary>
        ...
        static int Main(string[] args)
        {
            ...
            string eventLogID = "MIDChainSetPercentCriteriaLoad";
            string sourceModule = "ChainSetPercentCriteriaLoad.cs";
            ...
            ChainSetPercentCriteriaLoadProcess hlp;
            ...
            try
            {
                ...
                try
                {
                    ...
                    authentication = SAB.ClientServerSession.UserLogin(userId, passWd, eProcesses.ChainSetPercentCriteriaLoad);
                    ...
                    else
                    {
                        if (!File.Exists(fileLocation))
                        {
                            ...
                            msgText += "History / Plan Load Process NOT run";
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                hlp = new ChainSetPercentCriteriaLoadProcess(SAB, ref errorFound);
                                if (fileLocation.Substring(fileLocation.Length - 4).ToUpper() == ".XML")
                                {
                                    hlp.ProcessXMLTransFile(fileLocation, delimiter, ref errorFound);
                                }
                                else
                                {
                                    hlp.ProcessVariableFile(fileLocation, delimiter, ref errorFound);
                                }
                            }
                        }
                    }
