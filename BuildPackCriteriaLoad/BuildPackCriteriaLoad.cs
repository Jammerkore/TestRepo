...
{
	/// <summary>
	/// Summary description for BuildPackCriteriaLoad.
	/// </summary>
	class BuildPackCriteriaLoad
	{
		/// <summary>
		...
		static int Main(string[] args)
		{
			...
			string eventLogID = "MIDBuildPackCriteriaLoad";
			string sourceModule = "BuildPackCriteriaLoad.cs";
			...
			BuildPackCriteriaLoadProcess hlp;
			...
			try
			{
				...
				try
				{
					...
					authentication = SAB.ClientServerSession.UserLogin(userId, passWd, eProcesses.buildPackCriteriaLoad);
					...
					else
					{
						...
						else
						{
							...
							else
							{
								...
								hlp = new BuildPackCriteriaLoadProcess(SAB, ref errorFound);
